...
export class BattleActions {
	...
	modifyDamage(
		...
		} else if (move.multihitType === 'eldrich') {
			const eldrichModifier = 0.5;
			this.battle.debug(`Eldrich modifier: ${eldrichModifier}`);
			baseDamage = this.battle.modify(baseDamage, eldrichModifier);
		}
