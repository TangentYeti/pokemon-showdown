export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	voltoof: {
		...
		abilities: {0: "Reckless", 1: "Lightning Rod"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
		evos: ["Timberam"],
	...
	murmarsh: {
		...
		name: "Murmarsh",
		types: ["Dark", "Poison"],
		baseStats: {hp: 97, atk: 104, def: 73, spa: 69, spd: 94, spe: 43},
	...
	parafullo: {
		...
		name: "Parafullo",
		types: ["Normal", "Flying"],
		baseStats: {hp: 112, atk: 96, def: 61, spa: 55, spd: 98, spe: 103},
		abilities: {0: "Thick Fat", 1: "Fur Coat"},
		heightm: 2,
		weightkg: 150,
		color: "White",
	...
	drakolarmor: {
		...
		name: "Drakolarmor",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 103, atk: 95, def: 126, spa: 48, spd: 87, spe: 25},
		abilities: {0: "Battle Armor", 1: "Multiscale"},
		heightm: 2.6,
		weightkg: 120,
		color: "White",
