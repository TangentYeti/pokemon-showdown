export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	jigglypuff: {
		...
		evos: ["Wigglytuff"],
		eggGroups: ["Fairy"],
		otherFormes: ["Jigglypuff-Althon"],
		formeOrder: ["Jigglypuff", "Jigglypuff-Althon"],
	},
	wigglytuff: {
		num: 40,
		name: "Wigglytuff",
		...
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
		otherFormes: ["Wigglytuff-Althon"],
		formeOrder: ["Wigglytuff", "Wigglytuff-Althon"],
	},
	zubat: {
		num: 41,
		name: "Zubat",
		...
		evos: ["Golbat"],
		eggGroups: ["Flying"],
		otherFormes: ["Zubat-Althon"],
		formeOrder: ["Zubat", "Zubat-Althon"],
	},
	golbat: {
		num: 42,
		name: "Golbat",
		...
		evos: ["Crobat"],
		eggGroups: ["Flying"],
		otherFormes: ["Golbat-Althon"],
		formeOrder: ["Golbat", "Golbat-Althon"],
	},
	oddish: {
		num: 43,
		name: "Oddish",
		...
		evos: ["Gloom"],
		eggGroups: ["Grass"],
		otherFormes: ["Oddish-Althon"],
		formeOrder: ["Oddish", "Oddish-Althon"],
	},
	gloom: {
		num: 44,
		name: "Gloom",
		...
		eggGroups: ["Grass"],
		otherFormes: ["Gloom-Althon"],
		formeOrder: ["Gloom", "Gloom-Althon"],
	},
	vileplume: {
		num: 45,
		name: "Vileplume",
		...
		evoItem: "Leaf Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Vileplume-Althon"],
		formeOrder: ["Vileplume", "Vileplume-Althon"],
	},
	paras: {
		num: 46,
		name: "Paras",
	...
	psyduck: {
		...
		otherFormes: ["Psyduck-Althon"],
		formeOrder: ["Psyduck", "Psyduck-Althon"],
	},
	golduck: {
		num: 55,
		name: "Golduck",
		...
		evoLevel: 33,
		eggGroups: ["Water 1", "Field"],
		otherFormes: ["Golduck-Althon"],
		formeOrder: ["Golduck", "Golduck-Althon"],
	},
	mankey: {
		num: 56,
		name: "Mankey",
	...
	onix: {
		...
		evos: ["Steelix"],
		eggGroups: ["Mineral"],
		otherFormes: ["Onix-Althon"],
		formeOrder: ["Onix", "Onix-Althon"],
	},
	drowzee: {
		num: 96,
		name: "Drowzee",
	...
	voltorb: {
		...
		evos: ["Electrode"],
		eggGroups: ["Mineral"],
		otherFormes: ["Voltorb-Hisui", "Voltorb-Althon"],
		formeOrder: ["Voltorb", "Voltorb-Hisui", "Voltorb-Althon"],
	},
	voltorbhisui: {
		num: 100,
		name: "Voltorb-Hisui",
	...
	electrode: {
		...
		evoLevel: 30,
		eggGroups: ["Mineral"],
		otherFormes: ["Electrode-Hisui", "Electrode-Althon"],
		formeOrder: ["Electrode", "Electrode-Hisui", "Electrode-Althon"],
	},
	electrodehisui: {
		num: 101,
	...
	koffing: {
		...
		eggGroups: ["Amorphous"],
		otherFormes: ["Koffing-Althon"],
		formeOrder: ["Koffing", "Koffing-Althon"],
	},
	weezing: {
		num: 110,
		name: "Weezing",
		...
		evoLevel: 35,
		eggGroups: ["Amorphous"],
		otherFormes: ["Weezing-Galar", "Weezing-Althon"],
		formeOrder: ["Weezing", "Weezing-Galar", "Weezing-Althon"],
	},
	weezinggalar: {
		num: 110,
		name: "Weezing-Galar",
	...
	electabuzz: {
		...
		evos: ["Electivire"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Electabuzz-Althon"],
		formeOrder: ["ELectabuzz", "Electabuzz-Althon"],
	},
	magmar: {
		num: 126,
		name: "Magmar",
		...
		evos: ["Magmortar"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Magmar-Althon"],
		formeOrder: ["Magmar", "Magmar-Althon"],
	},
	pinsir: {
		num: 127,
		name: "Pinsir",
	...
	chikorita: {
		...
		evos: ["Bayleef"],
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Chikorita-Althon"],
		formeOrder: ["Chikorita", "Chikorita-Althon"],
	},
	bayleef: {
		num: 153,
		name: "Bayleef",
		...
		evos: ["Meganium"],
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Bayleef-Althon"],
		formeOrder: ["Bayleef", "Bayleef-Althon"],
	},
	meganium: {
		num: 154,
		name: "Meganium",
		...
		evoLevel: 32,
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Meganium-Althon"],
		formeOrder: ["Meganium", "Meganium-Althon"],
	},
	cyndaquil: {
		num: 155,
		name: "Cyndaquil",
		...
		evos: ["Quilava"],
		eggGroups: ["Field"],
		otherFormes: ["Cyndaquil-Althon"],
		formeOrder: ["Cyndaquil", "Cyndaquil-Althon"],
	},
	quilava: {
		num: 156,
		name: "Quilava",
		...
		eggGroups: ["Field"],
		otherFormes: ["Quilava-Althon"],
		formeOrder: ["Quilava", "Quilava-Althon"],
	},
	typhlosion: {
		num: 157,
		name: "Typhlosion",
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Typhlosion-Hisui", "Typhlosion-Althon"],
		formeOrder: ["Typhlosion", "Typhlosion-Hisui", "Typhlosion-Althon"],
	},
	typhlosionhisui: {
		num: 157,
	...
	totodile: {
		...
		evos: ["Croconaw"],
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Totodile-Althon"],
		formeOrder: ["Totodile", "Totodile-Althon"],
	},
	croconaw: {
		num: 159,
		name: "Croconaw",
		...
		evos: ["Feraligatr"],
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Croconaw-Althon"],
		formeOrder: ["Croconaw", "Croconaw-Althon"],
	},
	feraligatr: {
		num: 160,
		name: "Feraligatr",
		...
		evoLevel: 30,
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Feraligatr-Althon"],
		formeOrder: ["Feraligatr", "Feraligatr-Althon"],
	},
	sentret: {
		num: 161,
		name: "Sentret",
	...
	crobat: {
		...
		evoType: "levelFriendship",
		eggGroups: ["Flying"],
		otherFormes: ["Crobat-Althon"],
		formeOrder: ["Crobat", "Crobat-Althon"],
	},
	chinchou: {
		num: 170,
		name: "Chinchou",
	...
	igglybuff: {
		...
		eggGroups: ["Undiscovered"],
		canHatch: true,
		otherFormes: ["Igglybuff-Althon"],
		formeOrder: ["Igglybuff", "Igglybuff-Althon"],
	},
	togepi: {
		num: 175,
		name: "Togepi",
	...
	mareep: {
		...
		evos: ["Flaaffy"],
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Mareep-Althon"],
		formeOrder: ["Mareep", "Mareep-Althon"],
	},
	flaaffy: {
		num: 180,
		name: "Flaaffy",
		...
		evos: ["Ampharos"],
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Flaaffy-Althon"],
		formeOrder: ["Flaaffy", "Flaaffy-Althon"],
	},
	ampharos: {
		num: 181,
		name: "Ampharos",
		...
		evoLevel: 30,
		eggGroups: ["Monster", "Field"],
		otherFormes: ["Ampharos-Mega", "Ampharos-Althon"],
		formeOrder: ["Ampharos", "Ampharos-Mega", "Ampharos-Althon"],
	},
	ampharosmega: {
		num: 181,
		name: "Ampharos-Mega",
	...
	bellossom: {
		...
		evoItem: "Sun Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Bellossom-Althon"],
		formeOrder: ["Bellossom", "Bellossom-Althon"],
	},
	marill: {
		num: 183,
		name: "Marill",
	...
	dunsparce: {
		...
		eggGroups: ["Field"],
		otherFormes: ["Dunsparce-Althon"],
		formeOrder: ["Dunsparce", "Dunsparce-Althon"],
	},
	gligar: {
		num: 207,
		name: "Gligar",
	...
	steelix: {
		...
		evoItem: "Metal Coat",
		eggGroups: ["Mineral"],
		otherFormes: ["Steelix-Mega", "Steelix-Althon"],
		formeOrder: ["Steelix", "Steelix-Mega", "Steelix-Althon"],
	},
	steelixmega: {
		num: 208,
		name: "Steelix-Mega",
	...
	phanpy: {
		...
		evos: ["Donphan"],
		eggGroups: ["Field"],
		otherFormes: ["Phanpy-Althon"],
		formeOrder: ["Phanpy", "Phanpy-Althon"],
	},
	donphan: {
		num: 232,
		name: "Donphan",
		...
		evoLevel: 25,
		eggGroups: ["Field"],
		otherFormes: ["Donphan-Althon"],
		formeOrder: ["Donphan", "Donphan-Althon"],
	},
	porygon2: {
		num: 233,
		name: "Porygon2",
	...
	elekid: {
		...
		eggGroups: ["Undiscovered"],
		canHatch: true,
		otherFormes: ["Elekid-Althon"],
		formeOrder: ["Elekid", "Elekid-Althon"],
	},
	magby: {
		num: 240,
		name: "Magby",
		...
		eggGroups: ["Undiscovered"],
		canHatch: true,
		otherFormes: ["Magby-Althon"],
		formeOrder: ["Magby", "Magby-Althon"],
	},
	miltank: {
		num: 241,
		name: "Miltank",
	...
	seedot: {
		...
		otherFormes: ["Seedot-Althon"],
		formeOrder: ["Seedot", "Seedot-Althon"],
	},
	nuzleaf: {
		num: 274,
		name: "Nuzleaf",
		...
		evos: ["Shiftry"],
		eggGroups: ["Field", "Grass"],
		otherFormes: ["Nuzleaf-Althon"],
		formeOrder: ["Nuzleaf", "Nuzleaf-Althon"],
	},
	shiftry: {
		num: 275,
		name: "Shiftry",
		...
		evoItem: "Leaf Stone",
		eggGroups: ["Field", "Grass"],
		otherFormes: ["Shiftry-Althon"],
		formeOrder: ["Shiftry", "Shiftry-Althon"],
	},
	taillow: {
		num: 276,
		name: "Taillow",
	...
	sableye: {
		...
		color: "Purple",
		eggGroups: ["Human-Like"],
		otherFormes: ["Sableye-Mega", "Sableye-Althon"],
		formeOrder: ["Sableye", "Sableye-Mega", "Sableye-Althon"],
	},
	sableyemega: {
		num: 302,
		name: "Sableye-Mega",
	...
	spinda: {
		...
		otherFormes: ["Spinda-Althon"],
		formeOrder: ["Spinda", "Magmar-Althon"],
	},
	trapinch: {
		num: 328,
		name: "Trapinch",
		...
		otherFormes: ["Trapinch-Althon"],
		formeOrder: ["Trapinch", "Trapinch-Althon"],
	},
	vibrava: {
		num: 329,
		name: "Vibrava",
		...
		evos: ["Flygon"],
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Vibrava-Althon"],
		formeOrder: ["Vibrava", "Vibrava-Althon"],
	},
	flygon: {
		num: 330,
		name: "Flygon",
		...
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Flygon-Althon"],
		formeOrder: ["Flygon", "Flygon-Althon"],
	},
	cacnea: {
		num: 331,
		name: "Cacnea",
	...
	corphish: {
		...
		evos: ["Crawdaunt"],
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Corphish-Althon"],
		formeOrder: ["Corphish", "Corphish-Althon"],
	},
	crawdaunt: {
		num: 342,
		name: "Crawdaunt",
		...
		evoLevel: 30,
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Crawdaunt-Althon"],
		formeOrder: ["Crawdaunt", "Crawdaunt-Althon"],
	},
	baltoy: {
		num: 343,
		name: "Baltoy",
	...
	shuppet: {
		...
		evos: ["Banette"],
		eggGroups: ["Amorphous"],
		otherFormes: ["Shuppet-Althon"],
		formeOrder: ["Shuppet", "Shuppet-Althon"],
	},
	banette: {
		num: 354,
		name: "Banette",
		...
		evoLevel: 37,
		eggGroups: ["Amorphous"],
		otherFormes: ["Banette-Mega", "Banette-Althon"],
		formeOrder: ["Banette", "Banette-Mega", "Banette-Althon"],
	},
	banettemega: {
		num: 354,
		name: "Banette-Mega",
	...
	combee: {
		...
		evos: ["Vespiquen"],
		eggGroups: ["Bug"],
		otherFormes: ["Combee-Althon"],
		formeOrder: ["Combee", "Combee-Althon"],
	},
	vespiquen: {
		num: 416,
		name: "Vespiquen",
		...
		evoLevel: 21,
		eggGroups: ["Bug"],
		otherFormes: ["Vespiquen-Althon"],
		formeOrder: ["Vespiquen", "Vespiquen-Althon"],
	},
	pachirisu: {
		num: 417,
		name: "Pachirisu",
	...
	chatot: {
		...
		color: "Black",
		eggGroups: ["Flying"],
		otherFormes: ["Chatot-Althon"],
		formeOrder: ["Chatot", "Chatot-Althon"],
	},
	spiritomb: {
		num: 442,
		name: "Spiritomb",
	...
	electivire: {
		...
		evoItem: "Electirizer",
		eggGroups: ["Human-Like"],
		otherFormes: ["Electivire-Althon"],
		formeOrder: ["Electivire", "Electivire-Althon"],
	},
	magmortar: {
		num: 467,
		name: "Magmortar",
		...
		evoItem: "Magmarizer",
		eggGroups: ["Human-Like"],
		otherFormes: ["Magmortar-Althon"],
		formeOrder: ["Magmortar", "Magmortar-Althon"],
	},
	togekiss: {
		num: 468,
		name: "Togekiss",
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Althon", "Rotom-Lantern", "Rotom-Mixer", "Rotom-Windvane", "Rotom-Bouzuki", "Rotom-Clock"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Althon", "Rotom-Lantern", "Rotom-Mixer", "Rotom-Windvane", "Rotom-Bouzuki", "Rotom-Clock"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	manaphy: {
		...
		gender: "N",
		baseStats: { hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100 },
		abilities: { 0: "Hydration", 1: "Bodyguard"},
		heightm: 0.3,
		weightkg: 1.4,
		color: "Blue",
		tags: ["Mythical"],
	...
	purrloin: {
		...
		evos: ["Liepard"],
		eggGroups: ["Field"],
		otherFormes: ["Purrloin-Althon"],
		formeOrder: ["Purrloin", "Purrloin-Althon"],
	},
	liepard: {
		num: 510,
		name: "Liepard",
		...
		evoLevel: 20,
		eggGroups: ["Field"],
		otherFormes: ["Liepard-Althon"],
		formeOrder: ["Liepard", "Liepard-Althon"],
	},
	pansage: {
		num: 511,
		name: "Pansage",
	...
	roggenrola: {
		...
		evos: ["Boldore"],
		eggGroups: ["Mineral"],
		otherFormes: ["Roggenrola-Althon"],
		formeOrder: ["Roggenrola", "Roggenrola-Althon"],
	},
	boldore: {
		num: 525,
		name: "Boldore",
		...
		evos: ["Gigalith"],
		eggGroups: ["Mineral"],
		otherFormes: ["Boldore-Althon"],
		formeOrder: ["Boldore", "Boldore-Althon"],
	},
	gigalith: {
		num: 526,
		name: "Gigalith",
		...
		evoType: "trade",
		eggGroups: ["Mineral"],
		otherFormes: ["Gigalith-Althon"],
		formeOrder: ["Gigalith", "Gigalith-Althon"],
	},
	woobat: {
		num: 527,
		name: "Woobat",
	...
	venipede: {
		...
		evos: ["Whirlipede"],
		eggGroups: ["Bug"],
		otherFormes: ["Venipede-Althon"],
		formeOrder: ["Venipede", "Mareep-Althon"],
	},
	whirlipede: {
		num: 544,
		name: "Whirlipede",
		...
		evos: ["Scolipede"],
		eggGroups: ["Bug"],
		otherFormes: ["Whirlipede-Althon"],
		formeOrder: ["Whirlipede", "Whirlipede-Althon"],
	},
	scolipede: {
		num: 545,
		name: "Scolipede",
		...
		evoLevel: 30,
		eggGroups: ["Bug"],
		otherFormes: ["Scolipede-Althon"],
		formeOrder: ["Scolipede", "Scolipede-Althon"],
	},
	cottonee: {
		num: 546,
		name: "Cottonee",
	...
	elgyem: {
		...
		evos: ["Beheeyem"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Elgyem-Althon"],
		formeOrder: ["Elgyem", "Elgyem-Althon"],
	},
	beheeyem: {
		num: 606,
		name: "Beheeyem",
		...
		evoLevel: 42,
		eggGroups: ["Human-Like"],
		otherFormes: ["Beheeyem-Althon"],
		formeOrder: ["Beheeyem", "Beheeyem-Althon"],
	},
	litwick: {
		num: 607,
		name: "Litwick",
	...
	axew: {
		...
		evos: ["Fraxure"],
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Axew-Althon"],
		formeOrder: ["Axew", "Axew-Althon"],
	},
	fraxure: {
		num: 611,
		name: "Fraxure",
		...
		evos: ["Haxorus"],
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Fraxure-Althon"],
		formeOrder: ["Fraxure", "Fraxure-Althon"],
	},
	haxorus: {
		num: 612,
		name: "Haxorus",
		...
		evoLevel: 48,
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Haxorus-Althon"],
		formeOrder: ["Haxorus", "Haxorus-Althon"],
	},
	cubchoo: {
		num: 613,
		name: "Cubchoo",
	...
	skiddo: {
		...
		evos: ["Gogoat"],
		eggGroups: ["Field"],
		otherFormes: ["Skiddo-Althon"],
		formeOrder: ["Skiddo", "Skiddo-Althon"],
	},
	gogoat: {
		num: 673,
		name: "Gogoat",
		...
		evoLevel: 32,
		eggGroups: ["Field"],
		otherFormes: ["Gogoat-Althon"],
		formeOrder: ["Gogoat", "Gogoat-Althon"],
	},
	pancham: {
		num: 674,
		name: "Pancham",
		...
		evos: ["Pangoro"],
		eggGroups: ["Field", "Human-Like"],
		otherFormes: ["Pancham-Althon"],
		formeOrder: ["Pancham", "Pancham-Althon"],
	},
	pangoro: {
		num: 675,
		name: "Pangoro",
		...
		eggGroups: ["Field", "Human-Like"],
		otherFormes: ["Pangoro-Althon"],
		formeOrder: ["Pangoro", "Pangoro-Althon"],
	},
	furfrou: {
		num: 676,
		name: "Furfrou",
	...
	fomantis: {
		...
		evos: ["Lurantis"],
		eggGroups: ["Grass"],
		otherFormes: ["Fomantis-Althon"],
		formeOrder: ["Fomantis", "Fomantis-Althon"],
	},
	lurantis: {
		num: 754,
		name: "Lurantis",
		...
		evoCondition: "during the day",
		eggGroups: ["Grass"],
		otherFormes: ["Lurantis-Totem", "Lurantis-Althon"],
		formeOrder: ["Lurantis", "Lurantis-Totem", "Lurantis-Althon"],
	},
	lurantistotem: {
		num: 754,
		name: "Lurantis-Totem",
	...
	silicobra: {
		...
		evos: ["Sandaconda"],
		eggGroups: ["Field", "Dragon"],
		otherFormes: ["Silicobra-Althon"],
		formeOrder: ["Silicobra", "Silicobra-Althon"],
	},
	sandaconda: {
		num: 844,
		name: "Sandaconda",
		...
		otherFormes: ["Sandaconda-Althon"],
		formeOrder: ["Sandaconda", "Sandacondo-Althon"],
	},
	sandacondagmax: {
		num: 844,
	...
	toxel: {
		...
		otherFormes: ["Toxel-Althon"],
		formeOrder: ["Toxel", "Toxel-Althon"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
	},
	toxtricity: {
		...
		evoLevel: 30,
		eggGroups: ["Human-Like"],
		otherFormes: ["Toxtricity-Low-Key", "Toxtricity-Althon"],
		formeOrder: ["Toxtricity", "Toxtricity-Low-Key", "Toxtricity-Althon"],
	...
	cyclizar: {
		...
		color: "Green",
		eggGroups: ["Field"],
		otherFormes: ["Cyclizar-Althon"],
		formeOrder: ["Cyclizar", "Cyclizar-Althon"],
	},
	orthworm: {
		num: 968,
		name: "Orthworm",
	...
	pegane: {
		...
		baseStats: { hp: 35, atk: 43, def: 44, spa: 57, spd: 46, spe: 45 },
	...
	venagus: {
		...
		types: ["Flying", "Poison"],
		genderRatio: { M: 0.375, F: 0.625 },
		baseStats: { hp: 56, atk: 58, def: 59, spa: 78, spd: 63, spe: 76 },
		abilities: { 0: "Poison Point" },
		heightm: 1.4,
		weightkg: 36.3,
		color: "Grey",
	...
	snogon: {
		...
		name: "Snogon",
		types: ["Rock"],
		baseStats: {hp: 35, atk: 51, def: 41, spa: 59, spd: 39, spe: 45},
		abilities: {0: "Rock Head"},
		heightm: 0.4,
		weightkg: 6.3,
		color: "Brown",
	...
	goraze: {
		...
		name: "Goraze",
		types: ["Rock", "Dark"],
		baseStats: {hp: 64, atk: 72, def: 59, spa: 84, spd: 48, spe: 63},
		abilities: {0: "Rock Head"},
		heightm: 2.5,
		weightkg: 35,
		color: "Brown",
	...
	gordusa: {
		...
		name: "Gordusa",
		types: ["Rock", "Dark"],
		baseStats: {hp: 74, atk: 102, def: 70, spa: 110, spd: 73, spe: 106},
	...
	taurull: {
		...
		name: "Taurull",
		types: ["Fighting"],
		baseStats: {hp: 51, atk: 53, def: 50, spa: 24, spd: 43, spe: 49},
		abilities: {0: "Hustle"},
		heightm: 1,
		weightkg: 25,
		color: "Red",
	...
	minomith: {
		...
		name: "Minomith",
		types: ["Fighting", "Steel"],
		baseStats: {hp: 79, atk: 77, def: 73, spa: 37, spd: 59, spe: 65},
		abilities: {0: "Hustle"},
		heightm: 1.5,
		weightkg: 100,
		color: "Red",
	...
	matretaur: {
		...
		name: "Matretaur",
		types: ["Fighting", "Steel"],
		baseStats: {hp: 100, atk: 114, def: 103, spa: 68, spd: 74, spe: 76},
	...
	hagu: {
		...
		name: "Hagu",
		types: ["Ghost"],
		baseStats: {hp: 48, atk: 31, def: 31, spa: 58, spd: 52, spe: 50},
		abilities: {0: "Magic Guard"},
		heightm: 0.1,
		weightkg: 1,
		color: "Gray",
	...
	hagulae: {
		...
		name: "Hagulae",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 38, def: 36, spa: 85, spd: 91, spe: 85},
		abilities: {0: "Magic Guard"},
		heightm: 0.5,
		weightkg: 5,
		color: "Gray",
	...
	mekes: {
		...
		name: "Mekes",
		types: ["Bug"],
		baseStats: {hp: 26, atk: 26, def: 24, spa: 34, spd: 24, spe: 46},
		abilities: {0: "Hyper Cutter",1: "Quick Feet"},
		heightm: 0.1,
		weightkg: 1,
		color: "Gray",
		evos: ["Chrysekes"],
	...
	chrysekes: {
		...
		name: "Chrysekes",
		types: ["Bug"],
		baseStats: {hp: 62, atk: 26, def: 96, spa: 34, spd: 96, spe: 46},
	...
	siriver: {
		...
		name: "Siriver",
		types: ["Water"],
		baseStats: {hp: 43, atk: 52, def: 44, spa: 59, spd: 41, spe: 48},
		abilities: {0: "Sweet Veil",1: "Water Veil"},
		heightm: 1,
		weightkg: 7,
		color: "Blue",
		evos: ["Searen"],
	...
	searen: {
		...
		name: "Searen",
		types: ["Water", "Fairy"],
		baseStats: {hp: 54, atk: 67, def: 58, spa: 73, spd: 55, spe: 67},
		abilities: {0: "Sweet Veil",1: "Water Veil"},
		heightm: 1.6,
		weightkg: 20,
		color: "Blue",
	...
	catoffalo: {
		...
		name: "Catoffalo",
		types: ["Ground"],
		baseStats: {hp: 72, atk: 63, def: 56, spa: 36, spd: 59, spe: 39},
	...
	greffin: {
		...
		name: "Greffin",
		types: ["Normal", "Flying"],
		baseStats: {hp: 53, atk: 57, def: 40, spa: 34, spd: 60, spe: 58},
		abilities: {0: "Big Pecks",1: "Rivalry"},
		heightm: 0.7,
		weightkg: 5,
		color: "Brown",
		evos: ["Gryfaun"],
	...
	gryfaun: {
		...
		name: "Gryfaun",
		types: ["Normal", "Flying"],
		baseStats: {hp: 68, atk: 68, def: 59, spa: 52, spd: 73, spe: 76},
		abilities: {0: "Big Pecks",1: "Rivalry"},
		heightm: 1.1,
		weightkg: 20,
		color: "Brown",
	...
	araqmite: {
		...
		name: "Araqmite",
		types: ["Rock", "Bug"],
		baseStats: {hp: 34, atk: 62, def: 58, spa: 58, spd: 47, spe: 113},
	...
	allowatt: {
		...
		name: "Allowatt",
		types: ["Dark", "Electric"],
		baseStats: {hp: 40, atk: 71, def: 59, spa: 42, spd: 43, spe: 100},
		abilities: {0: "Quick Feet",1: "Strong Jaw"},
		heightm: 1,
		weightkg: 20,
		color: "Brown",
		evos: ["Allopere"],
	...
	crustark: {
		...
		name: "Crustark",
		types: ["Water"],
		baseStats: {hp: 51, atk: 64, def: 59, spa: 40, spd: 38, spe: 48},
		abilities: {0: "Defeatist",1: "Own Tempo"},
		heightm: 0.7,
		weightkg: 8,
		color: "Black",
		evos: ["Skarmish"],
	...
	skarmish: {
		...
		name: "Skarmish",
		types: ["Water", "Fighting"],
		baseStats: {hp: 67, atk: 84, def: 73, spa: 49, spd: 54, spe: 63},
		abilities: {0: "Defeatist",1: "Own Tempo"},
		heightm: 1.1,
		weightkg: 20,
		color: "Brown",
	...
	hootiny: {
		...
		name: "Hootiny",
		types: ["Flying"],
		baseStats: {hp: 69, atk: 44, def: 36, spa: 53, spd: 67, spe: 59},
		abilities: {0: "Insomnia"},
		heightm: 0.7,
		weightkg: 2,
		color: "Black",
	...
	nocteena: {
		...
		name: "Nocteena",
		types: ["Flying"],
		baseStats: {hp: 81, atk: 59, def: 51, spa: 67, spd: 84, spe: 76},
		abilities: {0: "Insomnia"},
		heightm: 1.1,
		weightkg: 20,
		color: "Brown",
	...
	pygmini: {
		...
		name: "Pygmini",
		types: ["Water", "Grass"],
		baseStats: {hp: 43, atk: 53, def: 48, spa: 53, spd: 49, spe: 41},
	...
	tadpoke: {
		...
		name: "Tadpoke",
		types: ["Grass"],
		baseStats: {hp: 45, atk: 67, def: 48, spa: 49, spd: 43, spe: 86},
	...
	toakwando: {
		...
		name: "Toakwando",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 57, atk: 87, def: 59, spa: 55, spd: 52, spe: 102},
	...
	reptiah: {
		...
		name: "Reptiah",
		types: ["Psychic"],
		baseStats: {hp: 50, atk: 49, def: 62, spa: 39, spd: 37, spe: 53},
		abilities: {0: "Multiscale", 1: "Dry Skin"},
		heightm: 1.5,
		weightkg: 12,
		color: "Black",
		evos: ["Prophegator"],
	...
	prophegator: {
		...
		name: "Prophegator",
		types: ["Psychic"],
		baseStats: {hp: 65, atk: 65, def: 80, spa: 45, spd: 42, spe: 68},
		abilities: {0: "Multiscale", 1: "Dry Skin"},
		heightm: 3.2,
		weightkg: 65,
		color: "Brown",
		evos: ["Sarcobral", "Cerekapro"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	sarcobral: {
	...
	appreti: {
		...
		name: "Appreti",
		types: ["Ice"],
		baseStats: {hp: 64, atk: 58, def: 55, spa: 28, spd: 61, spe: 34},
		abilities: {0: "Thick Fat"},
		heightm: 1.7,
		weightkg: 95,
		color: "White",
	...
	deproth: {
		...
		name: "Deproth",
		types: ["Normal", "Dark"],
		baseStats: {hp: 100, atk: 55, def: 34, spa: 62, spd: 59, spe: 60},
		abilities: {0: "Slow Start"},
		heightm: 1,
		weightkg: 12,
		color: "Black",
	...
	babression: {
		...
		name: "Babression",
		types: ["Normal", "Dark"],
		baseStats: {hp: 105, atk: 58, def: 43, spa: 73, spd: 69, spe: 67},
		abilities: {0: "Moody"},
		heightm: 1.4,
		weightkg: 65,
		color: "Brown",
	...
	kinertz: {
		...
		name: "Kinertz",
		types: ["Electric"],
		baseStats: {hp: 57, atk: 44, def: 36, spa: 44, spd: 36, spe: 63},
	...
	potoltage: {
		...
		name: "Potoltage",
		types: ["Electric"],
		baseStats: {hp: 70, atk: 51, def: 43, spa: 51, spd: 43, spe: 72},
		abilities: {0: "Volt Absorb", 1: "Lightning Rod"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
		evos: ["Vitalysis", "Anaphyletric"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	vitalysis: {
	...
	anaphyletric: {
		...
		abilities: {0: "Electric Surge", 1: "Stunning Entrance"},
		heightm: 2.7,
		weightkg: 1,
		color: "White",
		eggGroups: ["Mineral"],
	...
	egynx: {
		...
		name: "Egynx",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 74, atk: 36, def: 62, spa: 68, spd: 71, spe: 29},
	...
	riddypt: {
		...
		name: "Riddypt",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 88, atk: 47, def: 74, spa: 91, spd: 95, spe: 35},
		abilities: {0: "Sand Stream", 1: "Natural Cure"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
	...
	miserpy: {
		...
		name: "Miserpy",
		types: ["Dark", "Flying"],
		baseStats: {hp: 52, atk: 58, def: 39, spa: 41, spd: 49, spe: 71},
		abilities: {0: "Pickup ", 1: "Rattled"},
		heightm: 0.6,
		weightkg: 0.5,
		color: "Black",
		evos: ["Inflocktion"],
	...
	inflocktion: {
		...
		name: "Inflocktion",
		types: ["Dark", "Flying"],
		baseStats: {hp: 59, atk: 54, def: 51, spa: 74, spd: 56, spe: 86},
		abilities: {0: "Pickup", 1: "Rattled"},
		heightm: 1,
		weightkg: 4,
		color: "Brown",
	...
	yintrum: {
		...
		name: "Yintrum",
		types: ["Dragon"],
		baseStats: {hp: 68, atk: 59, def: 49, spa: 61, spd: 64, spe: 54},
		abilities: {0: "Inner Focus ", 1: "Contrary"},
		heightm: 1,
		weightkg: 7,
		color: "Black",
		evos: ["Yanquil"],
	...
	yanquil: {
		...
		name: "Yanquil",
		types: ["Dragon", "Psychic"],
		baseStats: {hp: 81, atk: 50, def: 45, spa: 76, spd: 87, spe: 61},
		abilities: {0: "Inner Focus", 1: "Contrary"},
		heightm: 2.2,
		weightkg: 15,
		color: "Brown",
	...
	zenriest: {
		...
		name: "Zenriest",
		types: ["Dragon", "Psychic"],
		baseStats: {hp: 92, atk: 64, def: 71, spa: 111, spd: 114, spe: 73},
		abilities: {0: "Inner Peace", 1: "Contrary"},
		heightm: 3,
		weightkg: 35,
		color: "White",
		eggGroups: ["Mineral"],
	...
	uki: {
		...
		name: "Uki",
		types: ["Psychic", "Ice"],
		baseStats: {hp: 51, atk: 51, def: 55, spa: 69, spd: 71, spe: 63},
	...
	ukitter: {
		...
		name: "Ukitter",
		types: ["Psychic", "Ice"],
		baseStats: {hp: 58, atk: 58, def: 64, spa: 101, spd: 104, spe: 80},
		abilities: {0: "Frosted Embrace", 1: "Ice Body"},
		heightm: 1.4,
		weightkg: 1,
		color: "Brown",
	...
	ukerial: {
		...
		name: "Ukerial",
		types: ["Psychic", "Ice"],
		baseStats: {hp: 71, atk: 71, def: 70, spa: 134, spd: 138, spe: 116},
		abilities: {0: "Frosted Embrace", 1: "Ice Body"},
		heightm: 1.6,
		weightkg: 50,
		color: "White",
	...
	scorath: {
		...
		name: "Scorath",
		types: ["Poison"],
		baseStats: {hp: 52, atk: 64, def: 55, spa: 62, spd: 33, spe: 74},
		abilities: {0: "Limber", 1: "Corrosion"},
		heightm: 1,
		weightkg: 3,
		color: "Black",
		evos: ["Armopoda"],
	...
	armopoda: {
		...
		name: "Armopoda",
		types: ["Poison", "Steel"],
		baseStats: {hp: 65, atk: 80, def: 100, spa: 63, spd: 47, spe: 80},
		abilities: {0: "Rough Skin", 1: "Corrosion"},
		heightm: 1,
		weightkg: 45,
		color: "Brown",
		evos: ["Armorpion"],
	...
	boosh: {
		...
		name: "Boosh",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 61, atk: 89, def: 63, spa: 57, spd: 53, spe: 77},
	...
	bespook: {
		...
		name: "Bespook",
		types: ["Ghost", "Normal"],
		baseStats: {hp: 58, atk: 66, def: 63, spa: 76, spd: 59, spe: 78},
	...
	feymur: {
		...
		name: "Feymur",
		types: ["Fairy"],
		baseStats: {hp: 65, atk: 68, def: 41, spa: 64, spd: 54, spe: 58},
		abilities: {0: "Rhythm", 1: "No Guard"},
		heightm: 1,
		weightkg: 0.5,
		color: "Black",
		evos: ["Fleymur"],
	...
	fleymur: {
		...
		name: "Fleymur",
		types: ["Fairy", "Fire"],
		baseStats: {hp: 81, atk: 83, def: 53, spa: 77, spd: 68, spe: 78},
		abilities: {0: "Rhythm", 1: "No Guard"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
	...
	mortarmur: {
		...
		name: "Mortarmur",
		types: ["Fairy", "Fire"],
		baseStats: {hp: 84, atk: 108, def: 50, spa: 93, spd: 73, spe: 92},
		abilities: {0: "Rhythm", 1: "No Guard"},
		heightm: 1.4,
		weightkg: 12,
		color: "White",
	...
	voltoof: {
		...
		name: "Voltoof",
		types: ["Grass", "Electric"],
		baseStats: {hp: 62, atk: 41, def: 59, spa: 67, spd: 48, spe: 63},
	...
	timberam: {
		...
		name: "Timberam",
		types: ["Grass", "Electric"],
		baseStats: {hp: 90, atk: 45, def: 95, spa: 118, spd: 68, spe: 79},
		abilities: {0: "Swift Swim", 1: "Chlorophyll"},
		heightm: 1.4,
		weightkg: 12,
		color: "White",
	...
	swaxic: {
		...
		name: "Swaxic",
		types: ["Grass", "Poison"],
		baseStats: {hp: 73, atk: 69, def: 73, spa: 69, spd: 94, spe: 43},
		abilities: {0: "Prankster"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
	...
	hammark: {
		...
		name: "Hammark",
		types: ["Water"],
		baseStats: {hp: 69, atk: 78, def: 61, spa: 55, spd: 48, spe: 51},
		abilities: {0: "Reckless", 1: "Swift Swim"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
		evos: ["Steahamark"],
	...
	steahamark: {
		...
		name: "Steahamark",
		types: ["Water", "Fire"],
		baseStats: {hp: 93, atk: 103, def: 79, spa: 69, spd: 58, spe: 68},
		abilities: {0: "Reckless", 1: "Swift Swim"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
	...
	carniveel: {
		...
		abilities: {0: "Stakeout", 1: "Drizzle"},
		heightm: 1.4,
		weightkg: 12,
		color: "White",
		eggGroups: ["Mineral"],
	...
	drecko: {
		...
		name: "Drecko",
		types: ["Dragon"],
		baseStats: {hp: 68, atk: 68, def: 70, spa: 72, spd: 62, spe: 27},
		abilities: {0: "Shed Skin", 1: "Colour Change"},
		heightm: 1,
		weightkg: 61,
		color: "Brown",
		evos: ["Dracorok"],
	...
	dracorok: {
		...
		name: "Dracorok",
		types: ["Dragon", "Rock"],
		baseStats: {hp: 66, atk: 69, def: 86, spa: 74, spd: 68, spe: 37},
	...
	mounteleon: {
		...
		abilities: {0: "Adaptability", 1: "Color Change"},
		heightm: 2.4,
		weightkg: 210,
		color: "White",
		eggGroups: ["Mineral"],
	...
	in: {
		...
		name: "I.N.",
		types: ["Grass", "Steel"],
		baseStats: {hp: 87, atk: 67, def: 90, spa: 25, spd: 45, spe: 16},
	...
	zentis: {
		...
		name: "Zentis",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 34, atk: 45, def: 43, spa: 76, spd: 72, spe: 21},
	...
	medizen: {
		...
		name: "Medizen",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 57, atk: 68, def: 56, spa: 99, spd: 94, spe: 26},
		abilities: {0: "Inner Focus", 1: "Trace"},
		heightm: 1,
		weightkg: 3.5,
		color: "Brown",
	...
	corean: {
		...
		name: "Corean",
		types: ["Ground"],
		baseStats: {hp: 57, atk: 35, def: 102, spa: 43, spd: 97, spe: 26},
	...
	felynx: {
		...
		name: "Felynx",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 63, atk: 34, def: 49, spa: 72, spd: 54, spe: 61},
		abilities: {0: "Vital Spirit", 1: "Overcoat"},
		heightm: 1,
		weightkg: 4,
		color: "Brown",
		evos: ["Lymbynx"],
	...
	desquire: {
		...
		name: "Desquire",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 57, atk: 72, def: 84, spa: 18, spd: 60, spe: 38},
		abilities: {0: "Defiant", 1: "Bodyguard"},
		heightm: 1,
		weightkg: 100,
		color: "Brown",
		evos: ["Defaith"],
	...
	defaith: {
		...
		name: "Defaith",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 65, atk: 89, def: 95, spa: 20, spd: 83, spe: 45},
		abilities: {0: "Defiant", 1: "Bodyguard"},
		heightm: 1.5,
		weightkg: 150,
		color: "Brown",
		evos: ["Defonour", "Destrayal"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	defonour: {
	...
	lycanobyl: {
		...
		abilities: {0: "Stench", 1: "Toxic Debris"},
		heightm: 1.9,
		weightkg: 28,
		color: "White",
		eggGroups: ["Mineral"],
	...
	chucabra: {
		...
		name: "Chucabra",
		types: ["Ground"],
		baseStats: {hp: 35, atk: 59, def: 54, spa: 43, spd: 38, spe: 59},
		abilities: {0: "Poison Point", 1: "Unburden"},
		heightm: 0.7,
		weightkg: 15,
		color: "Brown",
		evos: ["Chucaprace"],
	...
	chucaprace: {
		...
		name: "Chucaprace",
		types: ["Ground"],
		baseStats: {hp: 42, atk: 72, def: 62, spa: 51, spd: 48, spe: 75},
		abilities: {0: "Poison Point", 1: "Unburden"},
		heightm: 1,
		weightkg: 15,
		color: "Brown",
	...
	glacibitis: {
		...
		name: "Glacibitis",
		types: ["Dragon", "Ice"],
		baseStats: {hp: 72, atk: 107, def: 77, spa: 91, spd: 86, spe: 67},
		abilities: {0: "Chrystalise"},
		heightm: 1.4,
		weightkg: 53,
		color: "White",
		eggGroups: ["Mineral"],
	...
	cycliner: {
		...
		name: "Cycliner",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 102, atk: 69, def: 56, spa: 68, spd: 67, spe: 8},
	...
	spelyclops: {
		...
		name: "Spelyclops",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 121, atk: 103, def: 84, spa: 102, spd: 102, spe: 13},
		abilities: {0: "No Guard", 1: "Shadow Tag"},
		heightm: 1.7,
		weightkg: 353,
		color: "White",
	...
	kyvolt: {
		...
		name: "Kyvolt",
		types: ["Electric", "Rock"],
		baseStats: {hp: 61, atk: 52, def: 73, spa: 78, spd: 59, spe: 66},
	...
	kybohm: {
		...
		abilities: {0: "Galvanize", 1: "Levitate"},
		heightm: 1.7,
		weightkg: 235,
		color: "White",
		eggGroups: ["Mineral"],
	...
	froose: {
		...
		name: "Froose",
		types: ["Grass", "Ice"],
		baseStats: {hp: 86, atk: 71, def: 76, spa: 48, spd: 78, spe: 37},
	...
	moosicle: {
		...
		name: "Moosicle",
		types: ["Grass", "Ice"],
		baseStats: {hp: 107, atk: 97, def: 96, spa: 49, spd: 113, spe: 38},
		abilities: {0: "Thick Fat", 1: "Snow Warning"},
		heightm: 2.8,
		weightkg: 435,
		color: "White",
	...
	junra: {
		...
		name: "Junra",
		types: ["Dragon"],
		baseStats: {hp: 66, atk: 63, def: 45, spa: 63, spd: 50, spe: 33},
		abilities: {0: "Volt Absorb", 1: "Supreme Overlord"},
		heightm: 1,
		weightkg: 15,
		color: "Brown",
		evos: ["Gojukuda"],
	...
	gojukuda: {
		...
		abilities: {0: "Irradiate", 1: "Supreme Overlord"},
		heightm: 50,
		weightkg: 999,
		color: "White",
		eggGroups: ["Mineral"],
	...
	scraplet: {
		...
		name: "Scraplet",
		types: ["Steel"],
		baseStats: {hp: 80, atk: 70, def: 86, spa: 33, spd: 65, spe: 66},
		abilities: {0: "Intimidate", 1: "Steadfast"},
		heightm: 1,
		weightkg: 15,
		color: "Brown",
		evos: ["Vaporace"],
	...
	icito: {
		...
		name: "Icito",
		types: ["Bug", "Ice"],
		baseStats: {hp: 44, atk: 69, def: 35, spa: 76, spd: 66, spe: 75},
	...
	frosquito: {
		...
		name: "Frosquito",
		types: ["Bug", "Ice"],
		baseStats: {hp: 48, atk: 102, def: 38, spa: 97, spd: 71, spe: 89},
	...
	axolittle: {
		...
		name: "Axolittle",
		types: ["Psychic"],
		baseStats: {hp: 62, atk: 31, def: 42, spa: 68, spd: 66, spe: 61},
	...
	ambycoal: {
		...
		name: "Ambycoal",
		types: ["Psychic", "Fire"],
		baseStats: {hp: 74, atk: 37, def: 49, spa: 89, spd: 93, spe: 63},
		abilities: {0: "Frail Skin", 1: "Regenerator"},
		heightm: 1.3,
		weightkg: 15,
		color: "Brown",
	...
	novalotl: {
		...
		name: "Novalotl",
		types: ["Psychic", "Fire"],
		baseStats: {hp: 83, atk: 38, def: 71, spa: 119, spd: 126, spe: 63},
		abilities: {0: "Frail Skin", 1: "Regenerator"},
		heightm: 2.2,
		weightkg: 34,
		color: "White",
	...
	cephaqua: {
		...
		name: "Cephaqua",
		types: ["Ice", "Fire"],
		baseStats: {hp: 87, atk: 49, def: 55, spa: 105, spd: 74, spe: 50},
	...
	draby: {
		...
		abilities: {0: "Adaptability", 1: "Marvel Scale"},
		heightm: 1,
		weightkg: 15,
		color: "Brown",
		evos: ["Dranova", "Drabloom", "Drarate", "Draquake", "Dranyon", "Drachaun"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	dranova: {
		...
		name: "Dranova",
		types: ["Fire", "Dragon"],
		baseStats: {hp: 60, atk: 75, def: 55, spa: 105, spd: 90, spe: 130},
	...
	drabloom: {
		...
		name: "Drabloom",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 55, atk: 60, def: 75, spa: 90, spd: 130, spe: 105},
		abilities: {0: "Grassy Surge", 1: "Draconic Heritage"},
		heightm: 2.4,
		weightkg: 63,
		color: "White",
		eggGroups: ["Mineral"],
	...
	drarate: {
		...
		name: "Drarate",
		types: ["Fighting", "Dragon"],
		baseStats: {hp: 105, atk: 130, def: 90, spa: 55, spd: 60, spe: 75},
	...
	draquake: {
		...
		name: "Draquake",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 130, atk: 90, def: 105, spa: 75, spd: 55, spe: 60},
	...
	dranyon: {
		...
		name: "Dranyon",
		types: ["Rock", "Dragon"],
		baseStats: {hp: 90, atk: 105, def: 130, spa: 60, spd: 75, spe: 55},
	...
	drachaun: {
		...
		name: "Drachaun",
		types: ["Fairy", "Dragon"],
		baseStats: {hp: 75, atk: 55, def: 60, spa: 130, spd: 105, spe: 90},
		abilities: {0: "Misty Surge", 1: "Draconic Heritage"},
		heightm: 2.4,
		weightkg: 63,
		color: "White",
		eggGroups: ["Mineral"],
	...
	octern: {
		...
		name: "Octern",
		types: ["Dark"],
		baseStats: {hp: 67, atk: 62, def: 27, spa: 71, spd: 87, spe: 36},
		abilities: {0: "Poison Heal", 1: "Sticky Hold"},
		heightm: 0.7,
		weightkg: 5,
		color: "Brown",
		evos: ["Doctopus"],
	...
	doctopus: {
		...
		name: "Doctopus",
		types: ["Dark"],
		baseStats: {hp: 90, atk: 68, def: 31, spa: 92, spd: 102, spe: 45},
		abilities: {0: "Poison Heal", 1: "Sticky Hold"},
		heightm: 1.3,
		weightkg: 22,
		color: "Brown",
	...
	blat: {
		...
		name: "Blat",
		types: ["Dark"],
		baseStats: {hp: 52, atk: 64, def: 56, spa: 54, spd: 41, spe: 73},
		abilities: {0: "Dry Skin", 1: "Intimidate"},
		heightm: 0.3,
		weightkg: 5,
		color: "Brown",
		evos: ["Vampyre"],
	...
	vampyre: {
		...
		name: "Vampyre",
		types: ["Dark"],
		baseStats: {hp: 60, atk: 81, def: 63, spa: 68, spd: 46, spe: 102},
		abilities: {0: "Dry Skin", 1: "Intimidate"},
		heightm: 1.3,
		weightkg: 27,
		color: "Brown",
	...
	miaskma: {
		...
		name: "Miaskma",
		types: ["Psychic"],
		baseStats: {hp: 52, atk: 20, def: 50, spa: 63, spd: 66, spe: 34},
		abilities: {0: "Poison Heal", 1: "Guts"},
		heightm: 0.3,
		weightkg: 5,
		color: "Brown",
		evos: ["Damaskma"],
	...
	damaskma: {
		...
		name: "Damaskma",
		types: ["Psychic"],
		baseStats: {hp: 71, atk: 24, def: 66, spa: 86, spd: 94, spe: 39},
		abilities: {0: "Poison Heal", 1: "Guts"},
		heightm: 1.3,
		weightkg: 27,
		color: "Brown",
	...
	sektylo: {
		...
		name: "Sektylo",
		types: ["Bug"],
		baseStats: {hp: 58, atk: 68, def: 62, spa: 64, spd: 58, spe: 60},
	...
	ninguin: {
		...
		name: "Ninguin",
		types: ["Fighting", "Electric"],
		baseStats: {hp: 47, atk: 72, def: 43, spa: 66, spd: 54, spe: 73},
		abilities: {0: "Steadfast", 1: "Technician"},
		heightm: 1,
		weightkg: 6,
		color: "Brown",
		evos: ["Shuriguin"],
	...
	baaly: {
		...
		name: "Baaly",
		types: ["Normal"],
		baseStats: {hp: 68, atk: 73, def: 71, spa: 29, spd: 37, spe: 52},
		abilities: {0: "Fluffy", 1: "Battle Armor"},
		heightm: 1,
		weightkg: 23,
		color: "White",
		evos: ["Rambonkin"],
	...
	mernox: {
		...
		name: "Mernox",
		types: ["Electric", "Poison"],
		baseStats: {hp: 58, atk: 63, def: 75, spa: 60, spd: 72, spe: 51},
		abilities: {0: "Gelatinous", 1: "Volt Absorb"},
		heightm: 1,
		weightkg: 23,
		color: "White",
		evos: ["Rambonkin"],
	...
	mervenom: {
		...
		name: "Mervenom",
		types: ["Electric", "Poison"],
		baseStats: {hp: 68, atk: 77, def: 114, spa: 75, spd: 106, spe: 65},
		abilities: {0: "Gelatinous", 1: "Volt Absorb"},
		heightm: 1.6,
		weightkg: 8,
		color: "White",
	...
	narwimp: {
		...
		types: ["Ice", "Poison"],
		baseStats: {hp: 68, atk: 73, def: 71, spa: 29, spd: 37, spe: 52},
		abilities: {0: "Poison Point", 1: "Impaler"},
		heightm: 1.2,
		weightkg: 14,
		color: "White",
		evos: ["Rambonkin"],
	...
	tikape: {
		...
		name: "Tikape",
		types: ["Grass"],
		baseStats: {hp: 65, atk: 78, def: 58, spa: 18, spd: 45, spe: 84},
	...
	goriki: {
		...
		name: "Goriki",
		types: ["Grass"],
		baseStats: {hp: 89, atk: 101, def: 77, spa: 29, spd: 57, spe: 91},
		abilities: {0: "Rhythm", 1: "Tiki Mask"},
		heightm: 1.2,
		weightkg: 25,
		color: "White",
	...
	charsoon: {
		...
		name: "Charsoon",
		types: ["Water", "Electric"],
		baseStats: {hp: 57, atk: 68, def: 57, spa: 66, spd: 39, spe: 73},
	...
	psypent: {
		...
		name: "Psypent",
		types: ["Psychic", "Water"],
		baseStats: {hp: 35, atk: 65, def: 52, spa: 38, spd: 66, spe: 64},
		abilities: {0: "Shed Skin", 1: "Regenerator"},
		heightm: 1.4,
		weightkg: 25,
		color: "White",
		evos: ["Mystdra"],
	...
	mystdra: {
		...
		name: "Mystdra",
		types: ["Psychic", "Water"],
		baseStats: {hp: 47, atk: 86, def: 67, spa: 51, spd: 82, spe: 72},
		abilities: {0: "Shed Skin", 1: "Regenerator"},
		heightm: 2.3,
		weightkg: 42,
		color: "White",
	...
	hydoracle: {
		...
		name: "Hydoracle",
		types: ["Psychic", "Water"],
		baseStats: {hp: 65, atk: 118, def: 88, spa: 60, spd: 86, spe: 103},
		abilities: {0: "Shed Skin", 1: "Regenerator"},
		heightm: 4.8,
		weightkg: 75,
		color: "White",
	...
	dellin: {
		...
		name: "Dellin",
		types: ["Fairy"],
		baseStats: {hp: 52, atk: 57, def: 48, spa: 60, spd: 57, spe: 56},
		abilities: {0: "Cute Charm", 1: "Sweet Veil"},
		heightm: 1,
		weightkg: 8,
		color: "White",
		evos: ["Halestial", "Devastly"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	halestial: {
		...
		name: "Halestial",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 72, atk: 89, def: 104, spa: 61, spd: 70, spe: 64},
	...
	devastly: {
		...
		name: "Devastly",
		types: ["Fairy", "Dark"],
		baseStats: {hp: 64, atk: 70, def: 61, spa: 104, spd: 107, spe: 72},
	...
	ignix: {
		...
		name: "Ignix",
		types: ["Fire", "Ghost"],
		baseStats: {hp: 34, atk: 23, def: 51, spa: 57, spd: 63, spe: 67},
	...
	pyrectix: {
		...
		abilities: {0: "Flame Body", 1: "Ashen Grace"},
		heightm: 2.6,
		weightkg: 28,
		color: "White",
		eggGroups: ["Mineral"],
	...
	drakyk: {
		...
		name: "Drakyk",
		types: ["Dragon", "Fighting"],
		baseStats: {hp: 58, atk: 46, def: 61, spa: 65, spd: 51, spe: 59},
	...
	kraloch: {
		...
		name: "Kraloch",
		types: ["Dragon", "Fighting"],
		baseStats: {hp: 65, atk: 52, def: 80, spa: 82, spd: 56, spe: 75},
		abilities: {0: "Multiscale", 1: "Intimdate"},
		heightm: 1.5,
		weightkg: 34,
		color: "White",
		evos: ["Pyrectix"],
	...
	tremold: {
		...
		name: "Tremold",
		types: ["Ground", "Grass"],
		baseStats: {hp: 68, atk: 64, def: 61, spa: 43, spd: 58, spe: 58},
	...
	komouldo: {
		...
		name: "Komouldo",
		types: ["Ground", "Grass"],
		baseStats: {hp: 111, atk: 102, def: 92, spa: 55, spd: 87, spe: 73},
		abilities: {0: "Hunter's Mark", 1: "Tough Claws"},
		heightm: 2.1,
		weightkg: 125,
		color: "White",
	...
	cubunch: {
		...
		name: "Cubunch",
		types: ["Normal"],
		baseStats: {hp: 63, atk: 31, def: 52, spa: 22, spd: 31, spe: 38},
	...
	dojursa: {
		...
		name: "Dojursa",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 81, atk: 56, def: 69, spa: 33, spd: 42, spe: 60},
		abilities: {0: "Huge Power", 1: "Anger Point"},
		heightm: 1.5,
		weightkg: 34,
		color: "White",
	...
	volchic: {
		...
		name: "Volchic",
		types: ["Electric", "Fire"],
		baseStats: {hp: 53, atk: 45, def: 60, spa: 71, spd: 62, spe: 79},
	...
	vipierce: {
		...
		name: "Vipierce",
		types: ["Poison"],
		baseStats: {hp: 51, atk: 74, def: 44, spa: 62, spd: 24, spe: 61},
	...
	cerone: {
		...
		name: "Cerone",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 64, atk: 72, def: 62, spa: 69, spd: 58, spe: 60},
	...
	foalmise: {
		...
		name: "Foalmise",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 54, atk: 74, def: 67, spa: 36, spd: 58, spe: 93},
	...
	lilpine: {
		...
		name: "Lilpine",
		types: ["Normal"],
		baseStats: {hp: 31, atk: 53, def: 44, spa: 47, spd: 39, spe: 71},
	...
	marpine: {
		...
		abilities: {0: "Pickup", 1: "Sap Sipper"},
		heightm: 2,
		weightkg: 15,
		color: "White",
		eggGroups: ["Mineral"],
	...
	biappa: {
		...
		name: "Biappa",
		types: ["Normal"],
		baseStats: {hp: 61, atk: 52, def: 48, spa: 33, spd: 54, spe: 52},
	...
	appasky: {
		...
		name: "Appasky",
		types: ["Normal", "Flying"],
		baseStats: {hp: 104, atk: 83, def: 57, spa: 44, spd: 86, spe: 76},
		abilities: {0: "Thick Fat", 1: "Fur Coat"},
		heightm: 1.4,
		weightkg: 60,
		color: "White",
	...
	parafullo: {
		...
		name: "Parafullo",
		types: ["Normal", "Flying"],
		baseStats: {hp: 102, atk: 96, def: 61, spa: 65, spd: 98, spe: 83},
		abilities: {0: "Thick Fat", 1: "Fur Coat"},
		heightm: 2,
		weightkg: 150,
		color: "White",
	...
	jelava: {
		...
		name: "Jelava",
		types: ["Fire", "Poison"],
		baseStats: {hp: 72, atk: 52, def: 64, spa: 52, spd: 73, spe: 44},
		abilities: {0: "Jelly Armor", 1: "Magma Core"},
		heightm: 1.4,
		weightkg: 6,
		color: "White",
		evos: ["Magmelly"],
	...
	salasander: {
		...
		name: "Salasander",
		types: ["Ground", "Fire"],
		baseStats: {hp: 72, atk: 61, def: 35, spa: 64, spd: 66, spe: 61},
		abilities: {0: "Shed Skin", 1: "Dry Skin"},
		heightm: 1,
		weightkg: 3,
		color: "White",
		evos: ["Amphawkes"],
	...
	dampling: {
		...
		name: "Dampling",
		types: ["Water"],
		baseStats: {hp: 48, atk: 42, def: 54, spa: 62, spd: 58, spe: 56},
		abilities: {0: "Big Pecks", 1: "Hydration"},
		heightm: 0.7,
		weightkg: 4.5,
		color: "White",
		evos: ["Hurricrane"],
	...
	hurricrane: {
		...
		name: "Hurricrane",
		types: ["Water", "Flying"],
		baseStats: {hp: 79, atk: 55, def: 72, spa: 104, spd: 94, spe: 86},
		abilities: {0: "Gale Wings", 1: "Wind Rider"},
		heightm: 2.4,
		weightkg: 23,
		color: "White",
		eggGroups: ["Mineral"],
	...
	laveba: {
		...
		name: "Laveba",
		types: ["Fire", "Steel"],
		baseStats: {hp: 32, atk: 23, def: 63, spa: 34, spd: 62, spe: 11},
	...
	piscurtle: {
		...
		name: "Piscurtle",
		types: ["Water"],
		baseStats: {hp: 59, atk: 50, def: 42, spa: 50, spd: 31, spe: 41},
	...
	agurtle: {
		...
		name: "Agurtle",
		types: ["Water", "Steel"],
		baseStats: {hp: 72, atk: 71, def: 103, spa: 61, spd: 54, spe: 86},
		abilities: {0: "Shell Armor", 1: "Swift Swim"},
		heightm: 1.2,
		weightkg: 27,
		color: "White",
	...
	deserolin: {
		...
		name: "Deserolin",
		types: ["Ground"],
		baseStats: {hp: 59, atk: 58, def: 77, spa: 40, spd: 56, spe: 41},
	...
	drakolin: {
		...
		name: "Drakolin",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 81, atk: 69, def: 99, spa: 44, spd: 63, spe: 33},
		abilities: {0: "Battle Armor", 1: "Multiscale"},
		heightm: 1.5,
		weightkg: 83,
		color: "White",
	...
	fractastral: {
		...
		name: "Fractastral",
		types: ["Electric", "Fairy"],
		baseStats: {hp: 75, atk: 60, def: 80, spa: 122, spd: 127, spe: 46},
	...
	puppyre: {
		...
		name: "Puppyre",
		types: ["Dark", "Fire"],
		baseStats: {hp: 61, atk: 64, def: 47, spa: 61, spd: 59, spe: 73},
		abilities: {0: "Tough Claws", 1: "No Guard"},
		heightm: 0.4,
		weightkg: 8,
		color: "White",
		evos: ["Inferthrope"],
	...
	skelegram: {
		...
		name: "Skelegram",
		types: ["Ghost"],
		baseStats: {hp: 50, atk: 61, def: 42, spa: 29, spd: 43, spe: 43},
		abilities: {0: "Slow Start", 1: "Truant"},
		heightm: 0.8,
		weightkg: 0.1,
		color: "White",
		evos: ["Skeleavy"],
	...
	skeleavy: {
		...
		name: "Skeleavy",
		types: ["Ghost"],
		baseStats: {hp: 61, atk: 82, def: 63, spa: 40, spd: 54, spe: 64},
		abilities: {0: "Slow Start", 1: "Truant"},
		heightm: 1.3,
		weightkg: 38,
		color: "White",
	...
	termuny: {
		...
		name: "Termuny",
		types: ["Bug", "Ground"],
		baseStats: {hp: 35, atk: 72, def: 28, spa: 45, spd: 39, spe: 71},
	...
	terrormite: {
		...
		name: "Terrormite",
		types: ["Bug", "Ground"],
		baseStats: {hp: 63, atk: 106, def: 52, spa: 64, spd: 68, spe: 92},
		abilities: {0: "Swarm", 1: "Infiltrator"},
		heightm: 1.8,
		weightkg: 10,
		color: "White",
	...
	corake: {
		...
		name: "Corake",
		types: ["Poison"],
		baseStats: {hp: 57, atk: 62, def: 42, spa: 41, spd: 30, spe: 63},
	...
	venamba: {
		...
		name: "Venamba",
		types: ["Poison"],
		baseStats: {hp: 63, atk: 85, def: 52, spa: 49, spd: 34, spe: 92},
		abilities: {0: "Venomous", 1: "Shed Skin"},
		heightm: 1.4,
		weightkg: 13,
		color: "White",
		evos: ["Anaconoxious"],
	...
	anaconoxious: {
		...
		abilities: {0: "Constriction", 1: "Poison Touch"},
		heightm: 14,
		weightkg: 100,
		color: "White",
		eggGroups: ["Mineral"],
	...
	slugnant: {
		...
		name: "Slugnant",
		types: ["Bug", "Poison"],
		baseStats: {hp: 47, atk: 36, def: 72, spa: 62, spd: 87, spe: 11},
		abilities: {0: "Gooey", 1: "Stall"},
		heightm: 1,
		weightkg: 1.3,
		color: "White",
		evos: ["Slumucus"],
	...
	golost: {
		...
		name: "Golost",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 59, atk: 63, def: 71, spa: 42, spd: 54, spe: 48},
		abilities: {0: "Cursed Body", 1: "Solid Rock"},
		heightm: 1.2,
		weightkg: 130,
		color: "White",
		evos: ["Titectre", "Stalagtergeist"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	titectre: {
		...
		name: "Titectre",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 119, atk: 103, def: 126, spa: 52, spd: 92, spe: 38},
		abilities: {0: "Cursed Body", 1: "Solid Rock"},
		heightm: 45,
		weightkg: 999,
		color: "White",
	...
	stalagtergeist: {
		...
		name: "Stalagtergeist",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 89, atk: 103, def: 86, spa: 62, spd: 89, spe: 101},
		abilities: {0: "Cursed Body", 1: "Solid Rock"},
		heightm: 3,
		weightkg: 275,
		color: "White",
	...
	falust: {
		...
		name: "Falust",
		types: ["Normal", "Flying"],
		baseStats: {hp: 32, atk: 56, def: 36, spa: 56, spd: 33, spe: 84},
	...
	falreeze: {
		...
		name: "Falreeze",
		types: ["Normal", "Flying"],
		baseStats: {hp: 44, atk: 71, def: 47, spa: 71, spd: 45, spe: 103},
		abilities: {0: "Keen Eye", 1: "Gale Wings"},
		heightm: 0.5,
		weightkg: 3,
		color: "White",
	...
	falnado: {
		...
		name: "Falnado",
		types: ["Flying"],
		baseStats: {hp: 51, atk: 97, def: 57, spa: 97, spd: 57, spe: 121},
		abilities: {0: "Cloud Nine", 1: "Gale Wings"},
		heightm: 1.9,
		weightkg: 9,
		color: "White",
		eggGroups: ["Mineral"],
	...
	burloch: {
		...
		name: "Burloch",
		types: ["Water", "Poison"],
		baseStats: {hp: 64, atk: 37, def: 52, spa: 68, spd: 63, spe: 36},
		abilities: {0: "Effect Spore", 1: "Triage"},
		heightm: 0.5,
		weightkg: 3,
		color: "White",
		evos: ["Venobella"],
	...
	venobella: {
		...
		name: "Venobella",
		types: ["Water", "Poison"],
		baseStats: {hp: 89, atk: 52, def: 67, spa: 118, spd: 103, spe: 56},
		abilities: {0: "Effect Spore", 1: "Triage"},
		heightm: 1.2,
		weightkg: 29,
		color: "White",
	...
	chryield: {
		...
		name: "Chryield",
		types: ["Bug"],
		baseStats: {hp: 70, atk: 20, def: 70, spa: 20, spd: 70, spe: 20},
		abilities: {0: "Shed Skin", 1: "Swarm"},
		heightm: 0.6,
		weightkg: 6,
		color: "White",
		evos: ["Crickmire", "Crickoat", "Disaspider", "Orbider"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	crickoat: {
	...
	crickmire: {
		...
		name: "Crickmire",
		types: ["Bug", "Normal"],
		baseStats: {hp: 120, atk: 70, def: 60, spa: 130, spd: 90, spe: 60},
		abilities: {0: "Survivalist", 1: "Weak Armor"},
		heightm: 1.1,
		weightkg: 7.5,
		color: "White",
		eggGroups: ["Mineral"],
	...
	disaspider: {
		...
		name: "Disaspider",
		types: ["Bug", "Dark"],
		baseStats: {hp: 55, atk: 80, def: 70, spa: 65, spd: 120, spe: 140},
	...
	vesplume: {
		...
		name: "Vesplume",
		types: ["Bug", "Flying"],
		baseStats: {hp: 70, atk: 130, def: 75, spa: 80, spd: 65, spe: 110},
		abilities: {0: "Relentless", 1: "Anger Point"},
		heightm: 1.1,
		weightkg: 6,
		color: "White",
		eggGroups: ["Mineral"],
	...
	vesplatinum: {
		...
		name: "Vesplatinum",
		types: ["Bug", "Steel"],
		baseStats: {hp: 60, atk: 130, def: 100, spa: 65, spd: 65, spe: 110},
		abilities: {0: "Molten", 1: "Battle Armor"},
		heightm: 1.4,
		weightkg: 9,
		color: "White",
		eggGroups: ["Mineral"],
	...
	grapeetle: {
		...
		name: "Grapeetle",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 80, atk: 140, def: 80, spa: 55, spd: 105, spe: 70},
	...
	calimare: {
		...
		name: "Calimare",
		types: ["Ghost", "Water"],
		baseStats: {hp: 57, atk: 38, def: 69, spa: 49, spd: 69, spe: 68},
	...
	cepharbon: {
		...
		name: "Cepharbon",
		types: ["Ghost","Water"],
		baseStats: {hp: 69, atk: 41, def: 87, spa: 74, spd: 98, spe: 81},
		abilities: {0: "Liquid Ooze", 1: "Drizzle"},
		heightm: 1.7,
		weightkg: 46,
		color: "White",
	...
	zhouptor: {
		...
		name: "Zhouptor",
		types: ["Ground", "Grass"],
		baseStats: {hp: 68, atk: 65, def: 56, spa: 38, spd: 60, spe: 63},
		abilities: {0: "Avian", 1: "Rivalry"},
		heightm: 1,
		weightkg: 13,
		color: "White",
		evos: ["Junzhou"],
	...
	junzhou: {
		...
		name: "Junzhou",
		types: ["Ground","Grass"],
		baseStats: {hp: 83, atk: 101, def: 64, spa: 41, spd: 78, spe: 83},
		abilities: {0: "Avian", 1: "Rivalry"},
		heightm: 1.7,
		weightkg: 86,
		color: "White",
	...
	emtap: {
		...
		name: "Emtap",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 46, atk: 56, def: 64, spa: 62, spd: 44, spe: 78},
		abilities: {0: "Rock Head", 1: "Run Away"},
		heightm: 1.1,
		weightkg: 13,
		color: "White",
		evos: ["Flajara"],
	...
	Flajara: {
		...
		name: "Flajara",
		types: ["Dragon","Fire"],
		baseStats: {hp: 61, atk: 71, def: 79, spa: 82, spd: 54, spe: 103},
		abilities: {0: "Rock Head", 1: "Run Away"},
		heightm: 1.4,
		weightkg: 28,
		color: "White",
	...
	anklace: {
		...
		name: "Anklace",
		types: ["Ground", "Steel"],
		baseStats: {hp: 65, atk: 66, def: 64, spa: 58, spd: 59, spe: 38},
		abilities: {0: "Rough Skin", 1: "Battle Armor"},
		heightm: 1.1,
		weightkg: 200,
		color: "White",
		evos: ["Ankevlar"],
	...
	ankevlar: {
		...
		name: "Ankevlar",
		types: ["Ground","Steel"],
		baseStats: {hp: 89, atk: 86, def: 82, spa: 64, spd: 88, spe: 41},
	...
	ankorient: {
		...
		abilities: {0: "Piercing Armor", 1: "Anchored"},
		heightm: 4.2,
		weightkg: 750,
		color: "White",
		eggGroups: ["Mineral"],
	...
	recryes: {
		...
		name: "Recryes",
		types: ["Flying","Fighting"],
		baseStats: {hp: 64, atk: 54, def: 72, spa: 49, spd: 53, spe: 58},
		abilities: {0: "Justified", 1: "Unburden"},
		heightm: 1,
		weightkg: 8,
		color: "White",
		evos: ["Odivalk", "Valkischief"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	odivalk: {
		...
		name: "Odivalk",
		types: ["Flying", "Fighting"],
		baseStats: {hp: 83, atk: 117, def: 81, spa: 67, spd: 70, spe: 107},
		abilities: {0: "Justified", 1: "Unburden"},
		heightm: 2.2,
		weightkg: 75,
		color: "White",
	...
	valkischief: {
		...
		name: "Valkischief",
		types: ["Flying", "Fighting"],
		baseStats: {hp: 107, atk: 83, def: 117, spa: 67, spd: 91, spe: 60},
		abilities: {0: "Justified ", 1: "Unburden"},
		heightm: 1.7,
		weightkg: 68,
		color: "White",
	...
	dunush: {
		...
		name: "Dunush",
		types: ["Fighting", "Rock"],
		baseStats: {hp: 54, atk: 52, def: 53, spa: 27, spd: 22, spe: 42},
	...
	vicisteus: {
		...
		name: "Vicisteus",
		types: ["Fighting","Rock"],
		baseStats: {hp: 74, atk: 92, def: 78, spa: 37, spd: 37, spe: 62},
		abilities: {0: "Rock Head", 1: "Sheer Force"},
		heightm: 1.6,
		weightkg: 80,
		color: "White",
	...
	cublaze: {
		...
		name: "Cublaze",
		types: ["Fire","Fighting"],
		baseStats: {hp: 48, atk: 68, def: 53, spa: 42, spd: 54, spe: 50},
		abilities: {0: "Anger Point", 1: "Iron Fist"},
		heightm: 1.3,
		weightkg: 80,
		color: "White",
		evos: ["Solursa"],
	...
	albafrost: {
		...
		name: "Albafrost",
		types: ["Flying","Ice"],
		baseStats: {hp: 64, atk: 29, def: 32, spa: 63, spd: 36, spe: 36},
	...
	sickwea: {
		...
		name: "Sickwea",
		types: ["Steel","Ice"],
		baseStats: {hp: 40, atk: 47, def: 51, spa: 54, spd: 39, spe: 82},
	...
	ferrickle: {
		...
		name: "Ferrickle",
		types: ["Steel","Ice"],
		baseStats: {hp: 46, atk: 54, def: 67, spa: 63, spd: 48, spe: 104},
		abilities: {0: "Clear Body", 1: "Keen Eye"},
		heightm: 1,
		weightkg: 8,
		color: "White",
	...
	scythatchi: {
		...
		name: "Scythatchi",
		types: ["Steel", "Ice"],
		baseStats: {hp: 57, atk: 54, def: 87, spa: 79, spd: 57, spe: 116},
	...
	trustice: {
		...
		name: "Trustice",
		types: ["Fighting"],
		baseStats: {hp: 70, atk: 70, def: 150, spa: 150, spd: 150, spe: 50},
	...
	pisbug: {
		...
		name: "Pisbug",
		types: ["Ghost","Bug"],
		baseStats: {hp: 43, atk: 56, def: 58, spa: 60, spd: 52, spe: 71},
	...
	nineque: {
		...
		name: "Nineque",
		types: ["Grass","Fairy"],
		baseStats: {hp: 63, atk: 41, def: 45, spa: 56, spd: 62, spe: 59},
	...
	thefchan: {
		...
		name: "Thefchan",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 93, atk: 49, def: 67, spa: 85, spd: 104, spe: 87},
		abilities: {0: "Wandering Spirit", 1: "Grassy Surge"},
		heightm: 1.3,
		weightkg: 17,
		color: "White",
		eggGroups: ["Mineral"],
	...
	dustandr: {
		...
		name: "Dustandr",
		types: ["Dragon","Ground"],
		baseStats: {hp: 81, atk: 66, def: 49, spa: 32, spd: 49, spe: 54},
	...
	jormrust: {
		...
		name: "Jormrust",
		types: ["Dragon","Ground"],
		baseStats: {hp: 100, atk: 83, def: 61, spa: 41, spd: 63, spe: 67},
		abilities: {0: "Strong Jaw", 1: "Regenerator"},
		heightm: 3.2,
		weightkg: 54,
		color: "White",
	...
	orplink: {
		...
		name: "Orplink",
		types: ["Flying","Steel"],
		baseStats: {hp: 67, atk: 22, def: 68, spa: 57, spd: 73, spe: 33},
	...
	plaguerca: {
		...
		abilities: {0: "Unnerve", 1: "Gluttony"},
		heightm: 1,
		weightkg: 4.6,
		color: "White",
		eggGroups: ["Mineral"],
	...
	dolpder: {
		...
		name: "Dolpder",
		types: ["Dark","Water"],
		baseStats: {hp: 78, atk: 74, def: 62, spa: 31, spd: 51, spe: 72},
	...
	cherubble: {
		...
		name: "Cherubble",
		types: ["Rock","Fairy"],
		baseStats: {hp: 62, atk: 41, def: 71, spa: 59, spd: 72, spe: 3},
		abilities: {0: "Magma Armor", 1: "Mirror Armor"},
		heightm: 1.1,
		weightkg: 18,
		color: "White",
		evos: ["Chemerufe"],
	...
	chemerufe: {
		...
		name: "Chemerufe",
		types: ["Rock","Fairy"],
		baseStats: {hp: 70, atk: 49, def: 95, spa: 82, spd: 97, spe: 6},
		abilities: {0: "Magma Armor", 1: "Mirror Armor"},
		heightm: 2.2,
		weightkg: 54,
		color: "White",
	...
	bzzug: {
		...
		name: "Bzzug",
		types: ["Bug", "Electric"],
		baseStats: {hp: 22, atk: 64, def: 20, spa: 66, spd: 26, spe: 82},
	...
	frusk: {
		...
		name: "Frusk",
		types: ["Ground", "Ice"],
		baseStats: {hp: 49, atk: 63, def: 58, spa: 41, spd: 30, spe: 49},
	...
	goroadsion: {
		...
		name: "Goroadsion",
		types: ["Ground", "Ice"],
		baseStats: {hp: 63, atk: 87, def: 70, spa: 52, spd: 37, spe: 61},
		abilities: {0: "Solstice Core"},
		heightm: 1.7,
		weightkg: 12,
		color: "White",
	...
	porygene: {
		...
		name: "Porygene",
		types: ["Electric", "Steel"],
		baseStats: {hp: 70, atk: 70, def: 95, spa: 125, spd: 95, spe: 80},
		abilities: {0: "Download"},
		heightm: 1.6,
		weightkg: 34,
		color: "White",
	...
	galaquas: {
		...
		name: "Galaquas",
		types: ["Ice", "Water"],
		baseStats: {hp: 93, atk: 65, def: 119, spa: 87, spd: 104, spe: 57},
		abilities: {0: "Unaware", 1: "Purification"},
		heightm: 2.3,
		weightkg: 49,
		color: "White",
		eggGroups: ["Mineral"],
	...
	therrazor: {
		...
		name: "Therrazor",
		types: ["Rock", "Ground"],
		baseStats: {hp: 45, atk: 86, def: 43, spa: 55, spd: 55, spe: 81},
	...
	venoom: {
		...
		name: "Venoom",
		types: ["Dark", "Poison"],
		baseStats: {hp: 53, atk: 61, def: 58, spa: 45, spd: 56, spe: 57},
		abilities: {0: "Corrosion", 1: "Dissolve"},
		heightm: 1.4,
		weightkg: 12,
		color: "White",
		evos: ["Sinicabre"],
	...
	sinicabre: {
		...
		name: "Sinicabre",
		types: ["Dark", "Poison"],
		baseStats: {hp: 106, atk: 103, def: 92, spa: 47, spd: 96, spe: 71},
		abilities: {0: "Corrosion", 1: "Dissolve"},
		heightm: 4.3,
		weightkg: 75,
		color: "White",
	...
	soulard: {
		...
		name: "Soulard",
		types: ["Ghost"],
		baseStats: {hp: 45, atk: 60, def: 20, spa: 60, spd: 20, spe: 50},
		abilities: {0: "Filter", 1: "Hellborn"},
		heightm: 1,
		weightkg: 12,
		color: "White",
		evos: ["Wyvoul"],
	...
	wyvoul: {
		...
		name: "Wyvoul",
		types: ["Ghost"],
		baseStats: {hp: 60, atk: 90, def: 30, spa: 90, spd: 30, spe: 75},
		abilities: {0: "Filter", 1: "Hellborn"},
		heightm: 1.4,
		weightkg: 27,
		color: "White",
	...
	dragoulich: {
		...
		abilities: {0: "Soul Fury", 1: "Hellborn"},
		heightm: 4.3,
		weightkg: 75,
		color: "White",
		eggGroups: ["Mineral"],
	...
	haemogrief: {
		...
		name: "Haemogrief",
		types: ["Poison", "Dark"],
		baseStats: {hp: 65, atk: 30, def: 65, spa: 30, spd: 65, spe: 50},
		abilities: {0: "Wimp Out", 1: "Hellborn"},
		heightm: 1.2,
		weightkg: 27,
		color: "White",
		evos: ["Demogrievous"],
	...
	avacus: {
		...
		name: "Avacus",
		types: ["Fire", "Flying"],
		baseStats: {hp: 80, atk: 65, def: 35, spa: 65, spd: 35, spe: 35},
		abilities: {0: "Thick Fat", 1: "Hellborn"},
		heightm: 1.4,
		weightkg: 27,
		color: "White",
		evos: ["Dragoulich"],
	...
	demorcus: {
		...
		name: "Demorcus",
		types: ["Fire", "Flying"],
		baseStats: {hp: 172, atk: 111, def: 86, spa: 51, spd: 85, spe: 35},
		abilities: {0: "Thick Fat", 1: "Hellborn"},
		heightm: 4.3,
		weightkg: 75,
		color: "White",
	...
	magich: {
		...
		name: "Magich",
		types: ["Ghost", "Dark"],
		baseStats: {hp: 65, atk: 30, def: 55, spa: 70, spd: 60, spe: 25},
		abilities: {0: "Cursed Body", 1: "Hellborn"},
		heightm: 1.4,
		weightkg: 27,
		color: "White",
		evos: ["Dragoulich"],
	...
	lethalich: {
		...
		name: "Lethalich",
		types: ["Ghost", "Dark"],
		baseStats: {hp: 127, atk: 46, def: 74, spa: 135, spd: 101, spe: 57},
		abilities: {0: "Ethereal", 1: "Hellborn"},
		heightm: 4.3,
		weightkg: 75,
		color: "White",
		eggGroups: ["Mineral"],
	...
	tarrtrum: {
		...
		name: "Tarrtrum",
		types: ["Ground"],
		baseStats: {hp: 65, atk: 60, def: 55, spa: 25, spd: 55, spe: 45},
		abilities: {0: "Wonder Skin", 1: "Immunity"},
		heightm: 1.2,
		weightkg: 27,
		color: "White",
		evos: ["Tremasque"],
	...
	wefwect: {
		...
		name: "Wefwect",
		types: ["Ghost"],
		baseStats: {hp: 30, atk: 42, def: 62, spa: 51, spd: 70, spe: 23},
		abilities: {0: "Wimp Out"},
		heightm: 0.2,
		weightkg: 2,
		color: "White",
	...
	duplighoul: {
		...
		name: "Duplighoul",
		types: ["Ghost"],
		baseStats: {hp: 44, atk: 63, def: 114, spa: 93, spd: 142, spe: 34},
	...
	spookeye: {
		...
		name: "Spookeye",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 73, atk: 42, def: 36, spa: 81, spd: 52, spe: 58},
	...
	beholdrich: {
		...
		name: "Beholdrich",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 124, atk: 61, def: 52, spa: 133, spd: 72, spe: 83},
		abilities: {0: "Eldrich"},
		heightm: 1.6,
		weightkg: 4,
		color: "White",
	...
	cyanial: {
		...
		name: "Cyanial",
		types: ["Poison"],
		baseStats: {hp: 70, atk: 40, def: 65, spa: 50, spd: 65, spe: 70},
		abilities: {0: "Forewarn", 1: "Anticipation"},
		heightm: 1.2,
		weightkg: 27,
		color: "White",
		evos: ["Apoxicary"],
	...
	apoxicary: {
		...
		types: ["Dragon", "Poison"],
		baseForme: "Bulk",
		baseStats: {hp: 83, atk: 60, def: 120, spa: 60, spd: 120, spe: 62},
		abilities: {0: "Primal Sense"},
		heightm: 4.3,
		weightkg: 100,
		color: "White",
		eggGroups: ["Mineral"],
		otherFormes: ["Apoxicary-Brute"],
		formeOrder: ["Apoxicary", "Apoxicary-Brute"],
		tags: ["Fakemon"],
	},
	apoxicarybrute: {
		num: 1347,
		name: "Apoxicary-Brute",
		baseSpecies: "Apoxicary",
		forme: "Brute",
		types: ["Dragon", "Poison"],
		baseStats: { hp: 83, atk: 120, def: 60, spa: 62, spd: 60, spe: 120 },
		abilities: { 0: "Primal Sense" },
		heightm: 4.7,
		weightkg: 53,
		color: "Brown",
		eggGroups: ["Mineral"],
		requiredAbility: "Primal Sense",
		battleOnly: "Apoxicary",
		tags: ["Fakemon"],
	},
	snowvern: {
		num: 1348,
		name: "Snowvern",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 53, atk: 70, def: 54, spa: 34, spd: 41, spe: 63},
		abilities: {0: "Thick Fat", 1: "Nitrogenize"},
		heightm: 1.2,
		weightkg: 27,
		color: "White",
		evos: ["Frosvern"],
	...
	frosvern: {
		...
		name: "Frosvern",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 73, atk: 90, def: 74, spa: 49, spd: 51, spe: 83},
		abilities: {0: "Thick Fat", 1: "Nitrogenize"},
		heightm: 2.2,
		weightkg: 47,
		color: "White",
	...
	hypovernia: {
		...
		name: "Hypovernia",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 93, atk: 110, def: 94, spa: 64, spd: 71, spe: 103},
		abilities: {0: "Thick Fat", 1: "Nitrogenize"},
		heightm: 3.3,
		weightkg: 100,
		color: "White",
	...
	psiropod: {
		...
		baseStats: {hp: 80, atk: 60, def: 35, spa: 60, spd: 35, spe: 5},
		abilities: {0: "Long Reach", 1: "Filter"},
		heightm: 2.2,
		weightkg: 107,
		color: "White",
		evos: ["Argecton"],
	...
	argecton: {
		...
		name: "Argecton",
		types: ["Psychic", "Ground"],
		baseStats: {hp: 100, atk: 80, def: 50, spa: 90, spd: 50, spe: 10},
		abilities: {0: "Long Reach", 1: "Filter"},
		heightm: 4.2,
		weightkg: 147,
		color: "White",
	...
	psititan: {
		...
		name: "Psititan",
		types: ["Psychic", "Ground"],
		baseStats: {hp: 185, atk: 100, def: 65, spa: 120, spd: 85, spe: 15},
		abilities: {0: "Long Reach", 1: "Filter"},
		heightm: 53.3,
		weightkg: 999,
		color: "White",
	...
	rapclaw: {
		...
		name: "Rapclaw",
		types: ["Electric", "Poison"],
		baseStats: {hp: 40, atk: 71, def: 44, spa: 56, spd: 44, spe: 100},
		abilities: {0: "Hustle", 1: "Super Luck"},
		heightm: 1.2,
		weightkg: 17,
		color: "White",
		evos: ["Velochem"],
	...
	velochem: {
		...
		name: "Velochem",
		types: ["Electric", "Poison"],
		baseStats: {hp: 50, atk: 106, def: 59, spa: 86, spd: 59, spe: 130},
		abilities: {0: "Hustle", 1: "Super Luck"},
		heightm: 1.3,
		weightkg: 56,
		color: "White",
	...
	yuttengeist: {
		...
		name: "Yuttengeist",
		types: ["Ice", "Ghost"],
		baseStats: {hp: 98, atk: 133, def: 77, spa: 60, spd: 64, spe: 108},
		abilities: {0: "Fluffy", 1: "Cursed Body"},
		heightm: 3.3,
		weightkg: 156,
		color: "White",
		eggGroups: ["Mineral"],
	...
	herbara: {
		...
		name: "Herbara",
		types: ["Psychic", "Grass"],
		baseStats: {hp: 53, atk: 57, def: 38, spa: 56, spd: 78, spe: 63},
	...
	florabill: {
		...
		name: "Florabill",
		types: ["Psychic", "Grass"],
		baseStats: {hp: 93, atk: 57, def: 88, spa: 86, spd: 113, spe: 93},
		abilities: {0: "Psychic Surge", 1: "Soundproof"},
		heightm: 1.6,
		weightkg: 56,
		color: "White",
		eggGroups: ["Mineral"],
	...
	iagtic: {
		...
		name: "Iagtic",
		types: ["Ice", "Electric"],
		baseStats: {hp: 45, atk: 46, def: 43, spa: 72, spd: 52, spe: 82},
		abilities: {0: "Lightning Rod", 1: "Snow Cloak"},
		heightm: 0.4,
		weightkg: 7,
		color: "White",
		evos: ["Tundance"],
	...
	tundance: {
		...
		name: "Tundance",
		types: ["Ice", "Electric"],
		baseStats: {hp: 57, atk: 77, def: 63, spa: 104, spd: 68, spe: 121},
		abilities: {0: "Lightning Rod", 1: "Snow Cloak"},
		heightm: 1.3,
		weightkg: 56,
		color: "White",
	...
	mienfood: {
		...
		name: "Mienfood",
		types: ["Ghost", "Bug"],
		baseStats: {hp: 50, atk: 73, def: 47, spa: 59, spd: 53, spe: 68},
		abilities: {0: "Stake Out", 1: "Sharpness"},
		heightm: 0.6,
		weightkg: 6,
		color: "White",
		evos: ["Mienshantis"],
	...
	chatotalthon: {
		...
		baseStats: { hp: 50, atk: 35, def: 40, spa: 70, spd: 45, spe: 70 },
	...
	chitchatot: {
		...
		name: "Chitchatot",
		types: ["Flying", "Psychic"],
		baseStats: { hp: 90, atk: 59, def: 76, spa: 105, spd: 76, spe: 104 },
		abilities: { 0: "Shrill Voice", 1: "Prankster" },
		heightm: 1.8,
		weightkg: 85.2,
		color: "Brown",
		prevo: "Chatot-Althon",
	...
	fomantisalthon: {
		...
		types: ["Bug", "Rock"],
		baseStats: {hp: 45, atk: 39, def: 36, spa: 45, spd: 50, spe: 35},
	...
	lurantisalthon: {
		...
		types: ["Bug", "Rock"],
		baseStats: {hp: 95, atk: 64, def: 81, spa: 90, spd: 105, spe: 45},
		abilities: {0: "Mimicry", 1: "Shield Dust"},
		heightm: 1.9,
		weightkg: 110,
		color: "White",
		prevo: ["Fomantis-Althon"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	rotomalthon: {
	...
	dunspartan: {
		...
		name: "Dunspartan",
		types: ["Ground", "Fighting"],
		baseStats: {hp: 110, atk: 100, def: 100, spa: 65, spd: 95, spe: 45},
		abilities: {0: "Vital Spirit", 1: "Serene Grace"},
		heightm: 2.3,
		weightkg: 75,
		color: "White",
	...
	phanpyalthon: {
		...
		forme: "Althon",
		types: ["Steel", "Grass"],
		baseStats: { hp: 90, atk: 50, def: 60, spa: 40, spd: 60, spe: 40 },
		abilities: { 0: "Gooey", H: "Noxious Skin" },
		heightm: 0.5,
		weightkg: 33.5,
		color: "Blue",
		evos: ["Donphan-Althon"],
	...
	donphanalthon: {
		...
		forme: "Althon",
		types: ["Steel", "Grass"],
		baseStats: { hp: 90, atk: 60, def: 120, spa: 80, spd: 110, spe: 40 },
		abilities: { 0: "Gooey", H: "Noxious Skin" },
		heightm: 1.1,
		weightkg: 120,
		color: "Gray",
	...
	mastophan: {
		...
		name: "Mastophan",
		types: ["Steel", "Grass"],
		baseStats: {hp: 100, atk: 60, def: 120, spa: 87, spd: 123, spe: 40},
	...
	elgyemalthon: {
		...
		forme: "Althon",
		types: ["Psychic", "Ghost"],
		baseStats: { hp: 50, atk: 50, def: 50, spa: 85, spd: 70, spe: 30 },
		abilities: { 0: "Stench", 1: "Levitate"},
		heightm: 0.5,
		weightkg: 9.5,
		color: "Blue",
		evos: ["Beheeyem-Althon"],
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	beheeyemalthon: {
		...
		forme: "Althon",
		types: ["Psychic", "Ghost"],
		baseStats: { hp: 70, atk: 70, def: 70, spa: 110, spd: 90, spe: 45 },
		abilities: { 0: "Stench", 1: "Levitate"},
		heightm: 0.9,
		weightkg: 30.5,
		color: "Blue",
	...
	uraineeyem: {
		...
		name: "Uraineeyem",
		types: ["Psychic", "Ghost"],
		baseStats: { hp: 90, atk: 70, def: 100, spa: 130, spd: 115, spe: 30 },
		abilities: { 0: "Irradiate", 1: "Levitate"},
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
		prevo: "Beheeyem-Althon",
		evoLevel: 30,
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	igglybuffalthon: {
		...
		forme: "Althon",
		types: ["Dark"],
		baseStats: { hp: 90, atk: 65, def: 15, spa: 10, spd: 15, spe: 15 },
		abilities: { 0: "Oblivious", 1: "Stalwart"},
		heightm: 0.5,
		weightkg: 9.5,
		color: "Blue",
		evos: ["Jigglypuff-Althon"],
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	jigglypuffalthon: {
		...
		forme: "Althon",
		types: ["Dark"],
		baseStats: { hp: 115, atk: 80, def: 25, spa: 15, spd: 25, spe: 25 },
		abilities: { 0: "Oblivious", 1: "Stalwart"},
		heightm: 0.9,
		weightkg: 30.5,
		color: "Blue",
		prevo: "Igglybuff-Althon",
		evoLevel: 15,
		evos: ["Wigglytuff-Althon"],
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	wigglytuffalthon: {
		...
		forme: "Althon",
		types: ["Dark"],
		baseStats: { hp: 140, atk: 135, def: 70, spa: 30, spd: 70, spe: 50 },
		abilities: { 0: "Defiant", 1: "Stalwart"},
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
		prevo: "Jigglypuff-Althon",
		evoLevel: 30,
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	...
	boldorealthon: {
		...
		weightkg: 102,
		color: "Blue",
		prevo: "Roggenrola-Althon",
		evoLevel: 25,
		evos: ["Gigalith-Althon"],
		eggGroups: ["Mineral"],
		tags: ["Fakemon"],
	},
	gigalithalthon: {
	...
	corphishalthon: {
		...
		forme: "Althon",
		types: ["Fighting", "Water"],
		baseStats: { hp: 50, atk: 65, def: 43, spa: 35, spd: 35, spe: 80 },
		abilities: { 0: "Adaptability", 1: "Swift Swim"},
		heightm: 0.6,
		weightkg: 11.5,
		color: "Red",
		evos: ["Crawdaunt-Althon"],
		eggGroups: ["Water 1", "Water 3"],
		tags: ["Fakemon"],
	},
	crawdauntalthon: {
		...
		forme: "Althon",
		types: ["Fighting", "Water"],
		baseStats: { hp: 63, atk: 90, def: 65, spa: 85, spd: 65, spe: 83 },
		abilities: { 0: "Adaptability", 1: "Swift Swim"},
		heightm: 1.1,
		weightkg: 32.8,
		color: "Red",
	...
	revolaunt: {
		...
		name: "Revolaunt",
		types: ["Fighting", "Water"],
		baseStats: {hp: 74, atk: 109, def: 78, spa: 109, spd: 74, spe: 101},
		abilities: {0: "Adaptability", 1: "Swift Swim"},
		heightm: 1.3,
		weightkg: 35,
		color: "White",
	...
	skiddoalthon: {
		...
		forme: "Althon",
		types: ["Grass", "Fighting"],
		baseStats: { hp: 83, atk: 70, def: 77, spa: 21, spd: 61, spe: 28 },
	...
	shuppetalthon: {
		...
		forme: "Althon",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 46, atk: 67, def: 47, spa: 62, spd: 44, spe: 54 },
	...
	magbyalthon: {
		...
		types: ["Flying", "Fire"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 55, atk: 70, def: 37, spa: 75, spd: 45, spe: 83 },
		abilities: { 0: "Steam Engine", 1: "Wind Rider" },
		heightm: 0.7,
		weightkg: 21.4,
		color: "Red",
		evos: ["Magmar-Althon"],
	...
	magmaralthon: {
		...
		types: ["Flying", "Fire"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 85, atk: 93, def: 57, spa: 95, spd: 65, spe: 100 },
		abilities: { 0: "Steam Engine", 1: "Wind Rider" },
		heightm: 1.3,
		weightkg: 44.5,
		color: "Red",
	...
	elekidalthon: {
		...
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 63, atk: 37, def: 45, spa: 95, spd: 65, spe: 55 },
		abilities: { 0: "Lightning Rod", 1: "Illuminate" },
		heightm: 0.6,
		weightkg: 23.5,
		color: "Yellow",
		evos: ["Electabuzz-Althon"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
		tags: ["Fakemon"],
	},
	electabuzzalthon: {
		...
		types: ["Fairy", "Electric"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 85, atk: 57, def: 65, spa: 105, spd: 95, spe: 83 },
		abilities: { 0: "Lightning Rod", 1: "Vital Spirit" },
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "Elekid-Althon",
		evoLevel: 30,
		evos: ["Electivire-Althon"],
		eggGroups: ["Human-Like"],
		tags: ["Fakemon"],
	},
	electivirealthon: {
		...
		abilities: { 0: "Lightning Rod", 1: "Misty Surge" },
		heightm: 1.8,
		weightkg: 138.6,
		color: "Yellow",
		prevo: "Electabuzz-Althon",
		evoType: "trade",
		evoItem: "Electirizer",
		eggGroups: ["Human-Like"],
		tags: ["Fakemon"],
	...
	glabeeator: {
		...
		types: ["Ground", "Flying"],
		gender: "M",
		baseStats: { hp: 102, atk: 122, def: 90, spa: 50, spd: 70, spe: 70 },
		abilities: { 0: "Unnerve", 1: "Anger Point" },
		heightm: 1.1,
		weightkg: 12.5,
		color: "Black",
		prevo: "Combee-Althon",
	...
	sableyealthon: {
		...
		forme: "Althon",
		types: ["Fairy", "Psychic"],
		baseStats: { hp: 50, atk: 65, def: 100, spa: 65, spd: 90, spe: 35 },
	...
	onixalthon: {
		...
		forme: "Althon",
		types: ["Rock", "Dragon"],
		baseStats: { hp: 89, atk: 30, def: 69, spa: 71, spd: 111, spe: 15 },
		abilities: { 0: "Sturdy", 1: "Shed Skin"},
		heightm: 8.8,
		weightkg: 210,
		color: "Gray",
		evos: ["Steelix-Althon"],
	...
	panchamalthon: {
		...
		name: "Pancham-Althon",
		types: ["Grass", "Dragon"],
		baseStats: { hp: 60, atk: 69, def: 53, spa: 34, spd: 46, spe: 53 },
		abilities: { 0: "Gluttony", 1: "Inner Focus"},
		heightm: 0.6,
		weightkg: 8,
		color: "White",
		evos: ["Pangoro-Althon"],
	...
	pangoroalthon: {
		...
		name: "Pangoro-Althon",
		types: ["Grass", "Dragon"],
		baseStats: { hp: 115, atk: 124, def: 78, spa: 49, spd: 71, spe: 58 },
		abilities: { 0: "Gluttony", 1: "Inner Peace"},
		heightm: 2.1,
		weightkg: 136,
		color: "White",
		prevo: "Pancham-Althon",
		evoLevel: 32,
		evoCondition: "with a Dragon-type in the party",
		eggGroups: ["Field", "Human-Like"],
		tags: ["Fakemon"],
	},
	spindaalthon: {
	...
	spindojo: {
		...
		name: "Spindojo",
		types: ["Fairy", "Fighting"],
		baseStats: { hp: 100, atk: 110, def: 80, spa: 60, spd: 80, spe: 90 },
		abilities: { 0: "Oblivious", 1: "Tangled Feet" },
		heightm: 1.7,
		weightkg: 12.5,
		color: "Black",
	...
	mareepalthon: {
		...
		forme: "Althon",
		types: ["Dark"],
		baseStats: { hp: 72, atk: 23, def: 49, spa: 56, spd: 57, spe: 23 },
	...
	flaaffyalthon: {
		...
		forme: "Althon",
		types: ["Dragon", "Dark"],
		baseStats: { hp: 81, atk: 28, def: 67, spa: 77, spd: 78, spe: 34 },
		abilities: { 0: "Illuminate", 1: "Cursed Body" },
		heightm: 0.8,
		weightkg: 13.3,
		color: "Pink",
	...
	ampharosalthon: {
		...
		abilities: { 0: "Magnet Pull", 1: "Cursed Body" },
		heightm: 1.4,
		weightkg: 61.5,
		color: "Yellow",
		prevo: "Flaaffy-Althon",
		evoLevel: 30,
		eggGroups: ["Monster", "Field"],
		tags: ["Fakemon"],
	},
	purrloinalthon: {
		...
		forme: "Althon",
		types: ["Dark"],
		baseStats: { hp: 54, atk: 63, def: 49, spa: 58, spd: 35, spe: 71 },
		abilities: { 0: "Defiant", 1: "Cute Charm"},
		heightm: 0.4,
		weightkg: 10.1,
		color: "Purple",
		evos: ["Liepard-Althon"],
	...
	cyclizaralthon: {
		...
		forme: "Althon",
		types: ["Ice", "Normal"],
		baseStats: { hp: 70, atk: 105, def: 75, spa: 65, spd: 65, spe: 121 },
		abilities: { 0: "Slush Rush", 1: "Mountaineer" },
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	koffingalthon: {
		...
		name: "Koffing-Althon",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 35, atk: 50, def: 85, spa: 75, spd: 65, spe: 30 },
		abilities: { 0: "Levitate", 1: "Liquid Ooze"},
		heightm: 0.6,
		weightkg: 1,
		color: "Purple",
		evos: ["Weezing-Althon"],
	...
	weezingalthon: {
		...
		name: "Weezing-Althon",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 55, atk: 80, def: 110, spa: 95, spd: 95, spe: 55 },
		abilities: { 0: "Levitate", 1: "Liquid Ooze"},
		heightm: 1.2,
		weightkg: 9.5,
		color: "Purple",
	...
	hexxing: {
		...
		name: "Hexxing",
		types: ["Ghost", "Poison"],
		baseStats: { hp: 72, atk: 79, def: 112, spa: 114, spd: 101, spe: 52},
		abilities: { 0: "Levitate", 1: "Liquid Ooze"},
		heightm: 1.7,
		weightkg: 12.5,
		color: "Black",
		prevo: "Weezing-Althon",
		eggGroups: ["Amorphous"],
		tags: ["Fakemon"],
	},
	seedotalthon: {
		...
		forme: "Althon",
		types: ["Grass", "Flying"],
		baseStats: { hp: 38, atk: 16, def: 53, spa: 41, spd: 41, spe: 31 },
		abilities: { 0: "Shed Skin", 1: "Wind Power"},
		heightm: 0.5,
		weightkg: 4,
		color: "Brown",
		evos: ["Nuzleaf-Althon"],
	...
	nuzleafalthon: {
		...
		forme: "Althon",
		types: ["Grass", "Flying"],
		baseStats: { hp: 48, atk: 46, def: 43, spa: 81, spd: 31, spe: 91 },
	...
	venipedealthon: {
		...
		forme: "Althon",
		types: ["Rock", "Poison"],
		baseStats: { hp: 30, atk: 30, def: 59, spa: 30, spd: 39, spe: 57 },
		abilities: { 0: "Battle Armor", 1: "Speed Boost"},
		heightm: 0.4,
		weightkg: 5.3,
		color: "Red",
		evos: ["Whirlipede-Althon"],
		eggGroups: ["Bug"],
		tags: ["Fakemon"],
	},
	whirlipedealthon: {
		...
		forme: "Althon",
		types: ["Rock", "Poison"],
		baseStats: { hp: 40, atk: 40, def: 89, spa: 65, spd: 79, spe: 47 },
		abilities: { 0: "Battle Armor", 1: "Speed Boost"},
		heightm: 1.2,
		weightkg: 58.5,
		color: "Gray",
		prevo: "Venipede-Althon",
		evoLevel: 22,
		evos: ["Scolipede-Althon"],
		eggGroups: ["Bug"],
		tags: ["Fakemon"],
	},
	scolipedealthon: {
		...
		forme: "Althon",
		types: ["Rock", "Poison"],
		baseStats: { hp: 90, atk: 55, def: 99, spa: 100, spd: 89, spe: 72 },
		abilities: { 0: "Sturdy", 1: "Speed Boost"},
		heightm: 2.5,
		weightkg: 200.5,
		color: "Red",
		prevo: "Whirlipede-Althon",
		evoLevel: 30,
		eggGroups: ["Bug"],
		tags: ["Fakemon"],
	},
	oddishalthon: {
		...
		forme: "Althon",
		types: ["Water", "Flying"],
		baseStats: { hp: 50, atk: 45, def: 65, spa: 75, spd: 55, spe: 30 },
	...
	gloomalthon: {
		...
		forme: "Althon",
		types: ["Water", "Flying"],
		baseStats: { hp: 65, atk: 55, def: 85, spa: 85, spd: 65, spe: 40 },
		abilities: { 0: "Static", 1: "Chlorophyll" },
		heightm: 0.8,
		weightkg: 8.6,
		color: "Blue",
	...
	vileplumealthon: {
		...
		forme: "Althon",
		types: ["Water", "Flying"],
		baseStats: { hp: 80, atk: 65, def: 105, spa: 105, spd: 85, spe: 50 },
		abilities: { 0: "Static", 1: "Chlorophyll" },
		heightm: 1.2,
		weightkg: 18.6,
		color: "Red",
	...
	bellossomalthon: {
		...
		forme: "Althon",
		types: ["Water", "Ground"],
		baseStats: { hp: 70, atk: 65, def: 85, spa: 125, spd: 70, spe: 75 },
		abilities: { 0: "Dazzling", 1: "Chlorophyll" },
		heightm: 0.4,
		weightkg: 5.8,
		color: "Green",
		eggGroups: ["Grass"],
	...
	zubatalthon: {
		...
		forme: "Althon",
		types: ["Poison", "Rock"],
		baseStats: { hp: 60, atk: 55, def: 35, spa: 30, spd: 35, spe: 30 },
	...
	golbatalthon: {
		...
		forme: "Althon",
		types: ["Poison", "Rock"],
		baseStats: { hp: 90, atk: 85, def: 75, spa: 65, spd: 75, spe: 65 },
		abilities: { 0: "Earth Eater", 1: "Acid Breath" },
		heightm: 1.6,
		weightkg: 55,
		color: "Purple",
	...
	bayleefalthon: {
		...
		weightkg: 15.8,
		color: "Green",
		prevo: "Chikorita-Althon",
		evoLevel: 16,
		evos: ["Meganium-Althon"],
		eggGroups: ["Monster", "Grass"],
		tags: ["Fakemon"],
	},
	meganiumalthon: {
		...
		types: ["Grass", "Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 62, def: 100, spa: 109, spd: 106, spe: 70 },
		abilities: { 0: "Flash Fire", 1: "Solar Power" },
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
		prevo: "Bayleef-Althon",
		evoLevel: 32,
		eggGroups: ["Monster", "Grass"],
		tags: ["Fakemon"],
	},
	...
	quilavaalthon: {
		...
		weightkg: 19,
		color: "Yellow",
		prevo: "Cyndaquil-Althon",
		evoLevel: 14,
		evos: ["Typhlosion-Althon"],
		eggGroups: ["Field"],
		tags: ["Fakemon"],
	},
	typhlosionalthon: {
	...
	croconawalthon: {
		...
		weightkg: 25,
		color: "Blue",
		prevo: "Totodile-Althon",
		evoLevel: 18,
		evos: ["Feraligatr-Althon"],
		eggGroups: ["Monster", "Water 1"],
		tags: ["Fakemon"],
	},
	feraligatralthon: {
		...
		types: ["Water", "Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 86, atk: 105, def: 90, spa: 69, spd: 92, spe: 93 },
		abilities: { 0: "Sap Sipper", 1: "Defiant" },
		heightm: 2.3,
		weightkg: 88.8,
		color: "Blue",
		prevo: "Croconaw-Althon",
		evoLevel: 30,
		eggGroups: ["Monster", "Water 1"],
		tags: ["Fakemon"],
	},
	trapinchalthon: {
		...
		forme: "Althon",
		types: ["Fighting"],
		baseStats: { hp: 50, atk: 50, def: 50, spa: 55, spd: 40, spe: 45 },
		abilities: { 0: "Sand Force", 1: "Competitive"},
		heightm: 0.4,
		weightkg: 0.5,
		color: "Pink",
		evos: ["Vibrava-Althon"],
	...
	vibravaalthon: {
		...
		forme: "Althon",
		types: ["Fighting", "Electric"],
		baseStats: { hp: 50, atk: 50, def: 50, spa: 60, spd: 40, spe: 70 },
		abilities: { 0: "Sand Rush", 1: "Competitive"},
		heightm: 0.6,
		weightkg: 1,
		color: "Green",
		prevo: "Trapinch-Althon",
		evoLevel: 18,
		evos: ["Flygon-Althon"],
		eggGroups: ["Fairy", "Grass"],
		tags: ["Fakemon"],
	...
	flygonalthon: {
		...
		forme: "Althon",
		types: ["Fighting", "Electric"],
		baseStats: { hp: 80, atk: 80, def: 80, spa: 95, spd: 70, spe: 115 },
		abilities: { 0: "Sand Rush", 1: "Competitive"},
		heightm: 0.8,
		weightkg: 3,
		color: "Blue",
		prevo: "Vibrava-Althon",
		evoLevel: 27,
		eggGroups: ["Fairy", "Grass"],
		tags: ["Fakemon"],
	},
	tyrunch: {
		...
		types: ["Steel", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 68, atk: 89, def: 77, spa: 35, spd: 55, spe: 38 },
		abilities: { 0: "Reinforced", 1: "Strong Jaw" },
		heightm: 0.8,
		weightkg: 26,
		color: "Brown",
		evos: ["Tyranpact"],
	...
	amaurtic: {
		...
		types: ["Water", "Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 77, atk: 67, def: 50, spa: 63, spd: 59, spe: 46 },
	...
	axewalthon: {
		...
		forme: "Althon",
		types: ["Ice", "Dragon"],
		baseStats: { hp: 41, atk: 87, def: 60, spa: 30, spd: 40, spe: 62 },
	...
	fraxurealthon: {
		...
		forme: "Althon",
		types: ["Ice", "Dragon"],
		baseStats: { hp: 61, atk: 117, def: 70, spa: 40, spd: 50, spe: 72 },
		abilities: { 0: "Swift Swim", 1: "Mold Breaker"},
		heightm: 1,
		weightkg: 36,
		color: "Green",
	...
	psyduckalthon: {
		...
		forme: "Althon",
		types: ["Steel"],
		baseStats: { hp: 57, atk: 50, def: 60, spa: 62, spd: 33, spe: 53 },
		abilities: { 0: "Good as Gold", 1: "Lightning Rod"},
		heightm: 0.8,
		weightkg: 19.6,
		color: "Yellow",
		evos: ["Golduck-Althon"],
	...
	golduckalthon: {
		...
		forme: "Althon",
		types: ["Steel"],
		baseStats: { hp: 83, atk: 81, def: 100, spa: 105, spd: 50, spe: 81 },
		abilities: { 0: "Good as Gold", 1: "Lightning Rod" },
		heightm: 1.7,
		weightkg: 76.6,
		color: "Blue",
		prevo: "Psyduck-Althon",
		evoLevel: 33,
		eggGroups: ["Water 1", "Field"],
		tags: ["Fakemon"],
	},
	anuguard: {
		...
		types: ["Fire", "Fairy "],
		gender: "N",
		baseStats: { hp: 139, atk: 47, def: 103, spa: 103, spd: 129, spe: 49 },
		abilities: { 0: "Beast Boost" },
		heightm: 2.4,
		weightkg: 33.6,
		color: "Red",
	...
	malfalpha: {
		...
		types: ["Dark", "Fighting"],
		gender: "N",
		baseStats: { hp: 101, atk: 193, def: 83, spa: 53, spd: 67, spe: 73 },
		abilities: { 0: "Beast Boost" },
		heightm: 2.4,
		weightkg: 133.6,
		color: "Red",
	...
	calanity: {
		...
		types: ["Water"],
		gender: "N",
		baseStats: { hp: 97, atk: 91, def: 97, spa: 91, spd: 97, spe: 97 },
		abilities: { 0: "Beast Boost" },
		heightm: 2.4,
		weightkg: 33.6,
		color: "Red",
	...
	babanova: {
		...
		types: ["Ghost", "Rock"],
		gender: "N",
		baseStats: { hp: 103, atk: 79, def: 83, spa: 137, spd: 109, spe: 59 },
		abilities: { 0: "Beast Boost" },
		heightm: 2.4,
		weightkg: 333.6,
		color: "Red",
	...
	// Mons added after inital code
	sulfire: {
		num: 1384,
		name: "Sulfire",
		types: ["Fire", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 54, atk: 51, def: 42, spa: 52, spd: 52, spe: 49 },
		abilities: { 0: "Acid Breath"},
		heightm: 1.3,
		weightkg: 5.2,
		color: "Blue",
	...
	leomura: {
		...
		types: ["Fire", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 74, atk: 71, def: 52, spa: 82, spd: 72, spe: 64 },
		abilities: { 0: "Acid Breath" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	mantiphur: {
		...
		types: ["Fire", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 114, atk: 96, def: 72, spa: 132, spd: 102, spe: 84 },
	...
	lilljar: {
		...
		types: ["Rock", "Fairy"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 45, atk: 45, def: 50, spa: 50, spd: 40, spe: 35 },
	...
	mischra: {
		...
		types: ["Rock", "Fairy"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 65, atk: 55, def: 75, spa: 70, spd: 50, spe: 45 },
		abilities: { 0: "Sturdy", 1: "Magic Seal" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	obolittle: {
		...
		types: ["Psychic", "Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 40, def: 60, spa: 75, spd: 70, spe: 25 },
		abilities: { 0: "Solid Rock", 1: "Swift Swim"},
		heightm: 1.3,
		weightkg: 5.2,
		color: "Blue",
		evos: ["Stygian"],
	...
	stygian: {
		...
		types: ["Psychic", "Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 65, atk: 50, def: 70, spa: 85, spd: 80, spe: 30 },
		abilities: { 0: "Solid Rock", 1: "Swift Swim" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	charonix: {
		...
		types: ["Psychic", "Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 85, atk: 70, def: 95, spa: 110, spd: 105, spe: 35 },
		abilities: { 0: "Solid Rock", 1: "Magic Guard"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		prevo: "Stygian",
	...
	pebblet: {
		...
		types: ["Rock", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 60, atk: 30, def: 65, spa: 30, spd: 55, spe: 20 },
		abilities: { 0: "Slow Start", 1: "Rocky Payload" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		evoLevel: 39,
	...
	pillarus: {
		...
		types: ["Rock", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 120, atk: 75, def: 130, spa: 60, spd: 110, spe: 40 },
		abilities: { 0: "Slow Start", 1: "Rocky Payload"},
		heightm: 2.7,
		weightkg: 825,
		color: "Blue",
	...
	claydon: {
		...
		types: ["Rock", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 55, def: 70, spa: 25, spd: 35, spe: 25 },
		abilities: { 0: "Heavy Metal", 1: "Stamina" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		evoLevel: 39,
	...
	magolam: {
		...
		types: ["Rock", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 95, atk: 110, def: 135, spa: 50, spd: 65, spe: 35 },
		abilities: { 0: "Heavy Metal", 1: "Stamina"},
		heightm: 2.7,
		weightkg: 825,
		color: "Blue",
	...
	tartiny: {
		...
		types: ["Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 80, def: 60, spa: 30, spd: 50, spe: 35 },
		abilities: { 0: "Earth Eater", 1: "Ice Body" },
		heightm: 2.7,
		weightkg: 125,
		color: "Blue",
		evoLevel: 39,
	...
	tartanarch: {
		...
		types: ["Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 110, atk: 130, def: 95, spa: 50, spd: 85, spe: 60 },
		abilities: { 0: "Earth Eater", 1: "Ice Body"},
		heightm: 8.7,
		weightkg: 825,
		color: "Blue",
	...
	pentaling: {
		...
		types: ["Psychic", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 60, atk: 80, def: 55, spa: 35, spd: 50, spe: 55 },
	...
	voltorbalthon: {
		...
		gender: "N",
		baseStats: { hp: 40, atk: 30, def: 50, spa: 55, spd: 55, spe: 100 },
		abilities: { 0: "Anger Shell", 1: "Toxic Debris"},
		heightm: 0.5,
		weightkg: 13,
		color: "Red",
	...
	electrodealthon: {
		...
		types: ["Fire", "Fighting"],
		gender: "N",
		baseStats: { hp: 60, atk: 105, def: 60, spa: 85, spd: 60, spe: 120 },
		abilities: { 0: "Anger Shell", 1: "Toxic Debris"},
		heightm: 1.2,
		weightkg: 71,
		color: "Red",
