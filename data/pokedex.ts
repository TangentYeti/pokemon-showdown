export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	yintrum: {
		...
		abilities: {0: "Inner Focus ", 1: "Reptilian"},
		heightm: 1,
		weightkg: 7,
		color: "Black",
		evos: ["Yanquil"],
	...
	voltoof: {
		...
		name: "Voltoof",
		types: ["Grass", "Electric"],
		baseStats: {hp: 62, atk: 67, def: 59, spa: 41, spd: 48, spe: 63},
		abilities: {0: "Reckless", 1: "Motor Drive"},
		heightm: 1,
		weightkg: 1,
		color: "Brown",
		evos: ["Timberam"],
	...
	timberam: {
		...
		name: "Timberam",
		types: ["Grass", "Electric"],
		baseStats: {hp: 90, atk: 118, def: 95, spa: 45, spd: 68, spe: 79},
		abilities: {0: "Reckless", 1: "Motor Drive"},
		heightm: 1.4,
		weightkg: 12,
		color: "White",
	...
	marpine: {
		...
		abilities: {0: "Pickup", 1: "Pickpocket"},
		heightm: 2,
		weightkg: 15,
		color: "White",
		eggGroups: ["Mineral"],
